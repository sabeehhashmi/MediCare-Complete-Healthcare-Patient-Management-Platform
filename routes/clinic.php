...
use App\Http\Controllers\clinic\DepartmentController;
use App\Http\Controllers\clinic\UsersController;
use App\Http\Controllers\clinic\HospitalInsuranceController;
use App\Http\Controllers\clinic\HospitalAppointmenstsController;
use App\Http\Controllers\clinic\PatientsController;
use App\Http\Controllers\clinic\ChatController;
...
Route::middleware(['guest'])->group(function() {
    ...
    Route::post('/check_login', [LoginController::class, 'check_login'])->name('check_login');
     Route::post('cliniclogin/verify-login-otp',[LoginController::class, 'verifyLoginOtp'])->name('verify.login.otp');
    Route::post('/save_clinic', [LoginController::class, 'save_clinic'])->name('save_clinic');
    ...
    ->name('prescription.print-pdf');
        ...
        Route::get('/notifications', [ClinicDashboardController::class, 'notifications'])->name('notifications');
        Route::get('/dashboard', [ClinicDashboardController::class, 'dashboard'])->name('dashboard');
