...
use App\Http\Controllers\callcenter\AgentsController;
use App\Http\Controllers\callcenter\HospitalController;
use App\Http\Controllers\callcenter\LoginController;
use App\Http\Controllers\callcenter\HospitalDashboardController;
use App\Http\Controllers\callcenter\DoctorController;
use App\Http\Controllers\callcenter\DepartmentController;
use App\Http\Controllers\callcenter\UsersController;
use App\Http\Controllers\callcenter\ClinicController;
use App\Http\Controllers\callcenter\PatientsController;
use App\Http\Controllers\callcenter\HospitalInsuranceController;
use App\Http\Controllers\callcenter\HospitalAppointmenstsController;
use App\Http\Controllers\callcenter\InsurencePolicyController;
...
Route::middleware(['guest'])->group(function() {
    ...
    Route::post('callcenterlogin/verify-login-otp',[LoginController::class, 'verifyLoginOtp'])->name('verify.login.otp');
...
Route::middleware(['callcenter'])->group(function() {
    ...
    Route::post('appointments/toggle-urgent', 'App\Http\Controllers\callcenter\HospitalAppointmenstsController@toggleUrgent')->name('appointments.toggleUrgent');
...
->name('prescription.generate_pdf');
    ...
    Route::post("/appointment-loaddata", [DoctorController::class, 'appointmentLoadData'])->name('doctors.appointmentLoadData');
    Route::get("doctors/view-appointment/{id?}", [DoctorController::class, 'viewAppointment'])->name('doctors.viewAppointment');

    //created by usman
    Route::post('/doctors/patient_appointment_save',[DoctorController::class, 'patienttAppointmentSave'])->name('doctors.patienttAppointmentSave');
    Route::post('/doctors/patient_appointment_cancel', [DoctorController::class, 'patientAppointmentCancel'])->name('doctors.patienttAppointmentCancel');
    Route::post('/doctors/patient_appointment_completed',[DoctorController::class, 'patientAppointmentCompleted'])->name('doctors.patienttAppointmentCompleted');
    Route::post('/doctors/patient_appointment_confirmed',[DoctorController::class, 'patientAppointmentConfirmed'])->name('doctors.patienttAppointmentConfirmed');
    Route::post('/doctors/patient_appointment_rescheduled',[DoctorController::class ,'patientAppointmentRescheduled'])->name('doctors.patienttAppointmentRescheduled');
    ...
    Route::post('/patient_appointment_rescheduled',[DoctorController::class, 'patientAppointmentRescheduled'])->name('patienttAppointmentRescheduled');
    ...
    Route::post("/hospitalAppointmentsLoaddata", [HospitalAppointmenstsController::class, 'appointmentLoadData'])->name('callcenterAppointmentLoadData');
    Route::post("/reportsAppointmentsLoaddata", [HospitalAppointmenstsController::class, 'reportsappointmentLoadData'])->name('reportsAppointmentLoadData');
...
// hospital[HospitalController::class, 'availability']
    ...
    Route::get('get-clinic-doctors/{department_id}', [DoctorController::class, 'getClinicDoctors'])->name('get-clinic-doctors');//Route::get('/get-department-doctors/{department_id}', 'DoctorController@getDepartmentDoctors')->name('admin.get-department-doctors');
   ...
   Route::post('/load-data-agents', [AgentsController::class, 'load_data'])->name('load-data-agents');
   ...
   Route::post('/agents/status', [AgentsController::class, 'agentStatus'])->name('agents.agentStatus');
   Route::delete("agents/delete/{id}", [AgentsController::class, 'destory'])->name('agents.delete');
