!(function () {
    ...
    function m() {
        ...
        s.hasAttribute("data-layout") && "horizontal" == s.getAttribute("data-layout")
            ? (b("layout-horizontal"),
              ...
              "light" == s.hasAttribute("data-topbar")
                  ? (b("topbar-color-light"), document.body.setAttribute("data-topbar", "light"))
                  : "dark" == s.hasAttribute("data-topbar") && (b("topbar-color-dark"), document.body.setAttribute("data-topbar", "dark")),
    ...
    (window.onload = function () {
                    ...
                    t.href == l &&
                        ...
                        (e = t.parentElement) &&
                            ...
                            (a = e.parentElement) &&
                                ...
                                (s = a.parentElement) &&
                                    "side-menu" !== s.id &&
                                    (s.classList.add("mm-active"), (n = s.parentElement) && "side-menu" !== n.id && (n.classList.add("mm-show"), (o = n.parentElement) && "side-menu" !== o.id && o.classList.add("mm-active"))))));
                });
        }, 0),
                ...
                t.href == r &&
                    ...
                    (e = t.parentElement) &&
                        ...
                        (s = a.parentElement) &&
                            ...
                            n && (n.classList.add("active"), (o = n.parentElement) && (o.classList.add("active"), (l = o.parentElement) && l.classList.add("active"))))));
            }),
        ...
        (a = document.body),
        (s = document.getElementsByClassName("right-bar-toggle")),
        ...
        (a = document.getElementsByTagName("body")[0]).hasAttribute("data-layout") && "horizontal" == a.getAttribute("data-layout")
            ? (b("layout-horizontal"),
              "light" == a.hasAttribute("data-topbar")
                  ? (b("topbar-color-light"), document.body.setAttribute("data-topbar", "light"))
                  : "dark" == a.hasAttribute("data-topbar") && (b("topbar-color-dark"), document.body.setAttribute("data-topbar", "dark")),
              (document.getElementById("sidebar-setting").style.display = "none"),
              document.body.removeAttribute("data-sidebar"))
            : (b("layout-vertical"), (document.getElementById("sidebar-setting").style.display = "block")),
        a.hasAttribute("data-bs-theme") && "dark" == a.getAttribute("data-bs-theme") ? b("layout-mode-dark") : b("layout-mode-light"),
                ...
                t &&
                    ...
                    ("light" == t.target.value
                        ...
                        ? (document.body.setAttribute("data-bs-theme", "dark"),
                          ...
                          b("topbar-color-dark"))
                        : "bordered" == t.target.value && document.body.setAttribute("data-bs-theme", "bordered"));
            });
        }),
