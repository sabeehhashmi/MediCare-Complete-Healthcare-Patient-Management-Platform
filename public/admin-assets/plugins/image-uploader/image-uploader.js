...
(function ($) {
    ...
    $.fn.imageUploader = function (options) {
        ...
        let createImg = function (src, id,type='image') {
            console.log(src);
            ...
            let $container = $('<div>', {class: 'uploaded-image'}),
                ...
                $img = $($htype, {src: src,width:'100%'}).appendTo($container),
        ...
        let setPreview = function ($container, files) {
            ...
            $(files).each(function (i, file) {
                ...
                // Set preview
                $uploadedContainer.append(createImg(URL.createObjectURL(file), dataTransfer.items.length - 1,file.type));
