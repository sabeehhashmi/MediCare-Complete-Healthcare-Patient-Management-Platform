var App = (function ($) {
    ...
    var handleUI = function () {
        ...
        $("body").on("click", '[data-toggle="minimize"]', function (e) {
            ...
            if ($("body").hasClass("sidebar-icon-only")) {
                document.cookie =
                    "sidebar_icon_only=1; expires=Fri, 01 Jan 2038 12:00:00 UTC; path=/";
            } else {
                document.cookie =
                    "sidebar_icon_only=0; expires=Fri, 01 Jan 2038 12:00:00 UTC; path=/";
            }
        });
        ...
        $("body")
            .find('[data-role="view-password"]')
            .siblings('[type="password"]')
            .addClass("x-input-password");
    ...
    var handleUISearch = function () {
        ...
        $("body").on(
            "change",
            '.ui-search-view [name="search_name"]',
            function () {
        ...
        $("body")
            .find('.ui-search-view input[type="text"]')
        ...
        $("body").on("click", '[data-role="ui-search-download"]', function (e) {
            ...
            formData["search_name"] = $searchForm
                .find(".ui-search-input")
                .val();
    ...
    var _bindDatatable = function ($table) {
        ...
        $table.find("thead th").each(function (index) {
            ...
            if (typeof _cname == "undefined" || _cname == "") {
                showAlertModal(
                    "Datatable configuration error: missing colname for " +
                        (_cidx + 1),
                    "Error"
                );
                def.reject();
    ...
    var showConfirmModal = function (options, body, callback) {
        ...
        var $modal = $(
            '<div class="modal fade" tabindex="-1" role="dialog" aria-hidden="true"><div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document"><div class="modal-content"><div class="modal-body"><h4 class="fw-bold text-black text-center mt-4" style="font-size: 1.25rem">' +
                options["body"] +
                '</h4><div class="mt-4 mb-4 d-flex align-items-center gap-2 justify-content-center"><button type="button" class="btn btn-secondary fw-bold"  style="min-width:120px;" id="cancelBtn" data-bs-dismiss="modal">Cancel</button><button type="button" class="btn btn-primary fw-bold" style="min-width:120px;">' +
                options["buttonText"] +
                "</button></div></div></div></div>"
        );
        // var $modal = $('<div class="modal fade" tabindex="-1" role="dialog" aria-hidden="true"><div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document"><div class="modal-content"><div class="modal-header"><h5 class="modal-title">'+ options['title'] +'</h5><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button></div><div class="modal-body"><h4 class="fw-normal">'+ options['body'] +'</h4></div><div class="modal-footer d-flex align-items-center gap-2 justify-content-center"><button type="button" class="btn btn-secondary w-100" >Cancel</button><button type="button" class="btn btn-primary w-100">'+ options['buttonText'] +'</button></div></div></div></div>');
        $modal.modal("show");
    ...
    var showAlertModal = function (message, title) {
        ...
        var $modal = $(
            '<div class="modal fade" tabindex="-1" role="dialog" aria-hidden="true"><div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document"><div class="modal-content"><div class="modal-body"><h4 class="fw-bold text-black text-center mt-4" style="font-size: 1.25rem">' +
                options["body"] +
                '</h4><div class=" mt-4 mb-4 d-flex align-items-center gap-2 justify-content-center"><button type="button" class="btn btn-primary fw-bold" style="min-width:120px;">' +
                options["buttonText"] +
                "</button></div></div></div></div>"
        );
        // var $modal = $('<div class="modal fade" tabindex="-1" role="dialog" aria-hidden="true"><div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document"><div class="modal-content"><div class="modal-header"><h5 class="modal-title">'+ options['title'] +'</h5><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button></div><div class="modal-body"><h4 class="fw-normal">'+ options['body'] +'</h4></div><div class="modal-footer d-flex align-items-center gap-2 justify-content-center"><button type="button" class="btn btn-primary w-100">'+ options['buttonText'] +'</button></div></div></div></div>');
        $modal.modal("show");
