        ...
        <div class="row justify-content-center">
            <div class="col-lg-4 mb-4">
                <div class="user-card">
                    ...
                    <h3 class="user-card__name user-card-premium mt-4">Albert Owens <span class="user-card-premium-tooltip"> <span>Premium Membership</span> <img src="assets/images/premium.webp" class="img-fluid" style="height: 34px; margin-top: -10px;" alt=""></span></h3>
                ...
                <div class="user-card mb-30 p-0 overflow-hidden">
                    <div class="contest-card">
                        <div class="contest-card__thumb">
                            <img src="assets/images/1241580367.png" alt="image" />
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-6 mb-30">
                        <div class="contest-card">
                            ...
                            <div class="contest-card__thumb">
                                <img src="assets/images/50450450454.png" alt="image" />
                    ...
                    <div class="col-lg-6 mb-30">
                        <div class="contest-card">
                            <!-- <a href="#" class="item-link"></a> -->
                            <div class="contest-card__thumb">
                                <img src="assets/images/5450983021.png" alt="image" />
                                <!-- <a href="#" class="action-icon"><i class="far fa-heart"></i></a> -->
                                <a class="contest-num" href="#">
                                    <!-- <span>contest no:</span> -->
                                    <h4 class="number">Buy Now</h4>
