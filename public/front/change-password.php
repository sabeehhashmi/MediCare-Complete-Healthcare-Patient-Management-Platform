                            ...
                            <div class="row justify-content-center mt-4">
                                <div class="col-lg-6 mb-4">
                                    <div class="form-group mb-0 text-start">
                                        ...
                                        <input type="password" name="" id="" placeholder="Enter Old Password" value="">
                                    </div>
                                </div>
                                <div class="col-lg-6 mb-4">
                                    <div class="form-group mb-0 text-start">
                                        <label>New Password <sup>*</sup></label>
                                        <input type="password" name="" id="" placeholder="Enter New Password" value="">
                                    </div>
                                </div>
                                <div class="col-lg-6 mb-4">
                                    <div class="form-group mb-0 text-start">
                                        <label>Confirm New Password <sup>*</sup></label>
                                        <input type="password" name="" id="" placeholder="Enter Confirm New Password" value="">
                                    </div>
                                </div>
                                <div class="col-lg-6"></div>
                                <div class="col-lg-6 mt-3">
                                    <div class="form-group text-start mb-0">
                                        <button type="submit" class="cmn-btn w-100">Change Password</button>
                                    </div>                                
                                </div>
                            </div>
                        </form>
