...
class HospitalInsuranceController extends Controller
{
    ...
    {   
        ...
        return view("callcenter.our_insurance",  compact('page_heading', 'module_heading', 'name','hospital','insurances'));
    }
    ...
    public function create()
    {
        ...
        return view("callcenter.createhospital_insurance", compact('page_heading','module_heading', 'id','name','insurance_id','subinsurance_id','hospital','subinsurancepolices','insurancepolices','mode','id','department_manager','department_name','email','phone','dial_code'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('callcenter.ourinsurance')->with('success', 'Insurance information saved successfully.');
    }
    ...
    public function edit($id)
    {
        ...
        if ($insurance) {
            ...
            return view("callcenter.createhospital_insurance", compact('page_heading','module_heading','mode','id','hospital','insurancepolices','subinsurancepolices','hospitalId','name','insurance_id','subinsurance_id'));
         } else {
             abort(404);
         }
    }
    ...
    public function destroy($id)
    {
       ...
       return redirect()->route('callcenter.ourinsurance')->with('success', 'Insurance removed  successfully.');
