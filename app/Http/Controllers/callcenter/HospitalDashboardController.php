...
class HospitalDashboardController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $page_heading = "CallCenter Dashboard";
        ...
        $appointments = DoctorPatientAppointment::orderBy('id', 'desc')->take(5)->get();
        $totalagents = AgentUserDetail::where('callcenter_id', $callcenter->id)->count();
        $activeagents = AgentUserDetail::where('callcenter_id', $callcenter->id)->whereHas('user',function($q){
            $q->where('active',1);
        })->count();
       ...
       // $appointments = DoctorPatientAppointment::whereIn('doctor_id', $doctorIds)->orderBy('id', 'desc')->take(5)->with('patient')->get();
        ...
        // dd($appointments,$totalappointments,$totalagents,$activeagents,$inactiveagents);
        // dd($pendingappointments,$confirmappointments,$completedappointments,$cancelledappointments);
       ...
       $totalHospitals = Hospital::where('type', TYPE_HOSPITAL)->get()->count();
       $totalDoctors = Doctor::count();
        return view('callcenter.dashboard', compact('page_heading','activeagents',
        'inactiveagents','module_heading','totalagents','totalappointments','pendingappointments',
        'confirmappointments','completedappointments','cancelledappointments','appointments',
    'NewConsultation',
    ...
    public function notifications(){
        ...
        return view('callcenter.notifications', compact('page_heading','module_heading'));
    }
