...
class ClinicController extends Controller
{
    public function index(){
        ...
        return view('callcenter.clinics.index',compact('page_heading', 'module_heading'));
    }
    ...
    public function create($id=''){
        ...
        $trade_licenece = '';
        $hospital = null;
        $page = 'callcenter.clinics.create';
        $selected_department = [];
        if($id){
    ...
    public function save(REQUEST $request)
    {
        ...
        $o_data['redirect'] = route('callcenter.clinics');
        $rules = [
            'name_en' => 'required',
...
//                            HospitalImage::where('hospital_id', $hospital->id)->delete();
                        ...
                        if ($request->hasfile('images')) {
                          ...
                          activity_log('clinic_profile_created', "Clinic $user->name Profile Updated", [
                            'user_id' => $user->name
                        ]);
        ...
        ->addColumn('action', function($user) {
             $action = '<div class="dropdown mt-4 mt-sm-0">
                ...
                // if (get_user_permission('clinics', 'u')) {
                    $action.='<a class="dropdown-item complete-link" href="'.route('callcenter.clinics.clinicDetails',['id'=>$user->id]).'">View Clinic </a>';
                    $action.='<a class="dropdown-item complete-link" href="'.route('callcenter.clinics.edit',['id'=>$user->id]).'">Edit Clinic </a>';
                    // }
                ...
                href="'.route('callcenter.clinics.delete', ['id' => encrypt($user->id)]).'">
                <i class="flaticon-delete-1"></i> Delete Clinic
              </a>';

                $action.='<a class="dropdown-item complete-link" href="'.route('callcenter.doctors', ['clinic_id' => $user->id]).'">Doctors </a>';
                $action.='<a class="dropdown-item complete-link" href="'.route('callcenter.appointments',['clinic_id' =>$user->id]).'">View Appointments</a>';
                // if (get_user_permission('clinics', 'r')) {
                   // $action.='<a class="dropdown-item complete-link" href="'.route('callcenter.clinics.appointments',['id'=>$user->id]).'">Appointments </a>';
                // }
                // if (get_user_permission('insurence_policy', 'r')) {
                    $action.='<a class="dropdown-item complete-link" href="'.route('callcenter.clinics.insurances',['id'=>$user->id]).'">View Insurance </a>';
                // }
    ...
    public function doctors($id){
        ...
        return view('callcenter.doctors.doctors',compact('page_heading', 'hospital_id', 'hospital'));
    ...
    public function appointments($id){
        ...
        $hospital = Hospital::find($hospital_id);
        $page_heading.= $hospital ? ('- '.$hospital->name_en) : '';
        return view('callcenter.clinics.appointment',compact('page_heading','hospital','hospital_id'));
    }
        ...
        ->addColumn('action', function($user) {
             $action = '<div class="dropdown mt-4 mt-sm-0">
                ...
                // if (get_user_permission('patients', 'r')) {
                    $action .= '<a class="dropdown-item complete-link" href="'.route('callcenter.clinics.edit_appointment', ['hospital_id' => $user->hospital_id ?? null, 'id' => $user->id]).'">Edit</a>';
    ...
    public function create_appointment($hospital_id, $id = '')
    {
        ...
        $page_heading.= $hospital ? ('- '.$hospital->name_en) : '';
        // dd($row->toArray());
        return view('callcenter.clinics.make_appointment', compact(
            'page_heading',
            'id',
            'patients',
            'hospital_id',
    ...
    public function saveAppointment(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            $status = "1";
            $o_data['redirect'] = route('callcenter.clinics.appointments', $request->hospital);
        }
    ...
    public function insurances($id){
        ...
        $module_heading="Clinic Insurances";
        $page_heading.= $hospital ? ('- '.$hospital->name_en) : '';
        ...
        return view('callcenter.clinics.insurances',compact('page_heading', 'hospital_id', 'hospital', 'list', 'module_heading'));
    ...
    public function createInsurance($hospital_id, $id = '')
    {
        ...
        return view('callcenter.clinics.createInsurance', compact('page_heading', 'id', 'hospital_id', 'row', 'insurances', 'sub_insurance_list'));
    }
    ...
    public function saveInsurance(Request $request)
    {
        ...
        $o_data['redirect'] = route('callcenter.clinics.insurances', $request->hospital_id ?? null);
    ...
    public function locations($id){
        ...
        return view('callcenter.clinics.locations',compact('page_heading', 'hospital_id', 'hospital', 'list'));
    ...
    public function createLocation($hospital_id, $id = '')
    {
        ...
        return view('callcenter.clinics.createLocation', compact('page_heading', 'id', 'hospital_id', 'row'));
    }
    ...
    public function saveLocation(Request $request)
    {
        ...
        $o_data['redirect'] = route('callcenter.clinics.locations', $request->hospital_id ?? null);
    ...
    foreach ($groupedInsurancePolicies as $insuranceId => $policies) {
        ...
        return view('callcenter.hospitals.viewclinic',compact('page_heading','module_heading','hospital','hospitalInsurancePolicies'));
