...
class UsersController extends Controller
{
    ...
    public function change_password(Request $request)
    {
        if ($request->isMethod('post')) {
            ...
            return view("hospital.change_password", compact('page_heading','module_heading','hospitalId','name','hospital'));
        }
    }
    ...
    public function edit_profile()
    {
        ...
        $hospital = Hospital::where('user_id',$loginuserid)->get()->first();
        $hospitalId  = $hospital->id;
        $page_heading="Edit Hospital Profile";
        $module_heading="Hospital Profile";
        ...
        if($hospitalId){
            ...
            if($hospital){
                ...
                $country = CountryModel::where(['active'=>1, 'id'=>$country_id])->whereIn('prefix', ALLOWED_COUNTRIES_PREF)->first();
            }
        ...
        return view("hospital.edit_profile",  compact('page_heading', 'module_heading', 'hospital','country','hospitalId','country_list', 'emirates_list', 'area_list', 'country_id', 'emirate_id', 'area_id', 'name','name_ar','trade_licenece' ));
    }
    ...
    public function get_profile()
    {
        ...
        // dd($hospital->user);
        return view("hospital.hospital_profile", compact('page_heading', 'module_heading', 'totaldoctors','totalpatients','hospital','country','hospitalId','country_list', 'emirates_list', 'area_list', 'country_id', 'emirate_id', 'area_id', 'name','name_ar','trade_licenece' ));
    }
...
public function HospitalDoctorsReviews(){
        ...
        return view('hospital.reviews', compact('reviews'));
