...
class DepartmentController extends Controller
{
    ...
    {  
        ...
        return view('hospital.departmentlist',compact('page_heading', 'module_heading', 'hospital_id', 'hospital', 'department_list'));
    }
    ...
    public function create($id = '')
    {
        ...
        return view('hospital.createDepartment', compact('page_heading', 'module_heading', 'id', 'hospital_id', 'row', 'departments'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $o_data['redirect'] = route('hospital.departments');
    ...
    public function edit($id)
    {
        ...
        if ($department) {
            ...
            return view("hospital.createdepartment", compact('page_heading','module_heading', 'departments','selected_department_id','mode','id','department_manager','department_name','email','phone','dial_code'));
         } else {
             abort(404);
         }
    }
