...
class DashboardController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $totalappointments = DoctorPatientAppointment::where('doctor_id', $doctorId)->count();
        $pendingappointments = DoctorPatientAppointment::where('doctor_id', $doctorId)->where('booking_status', BOOKING_STATUS_PENDING)->count();
        $confirmappointments = DoctorPatientAppointment::where('doctor_id', $doctorId)->where('booking_status', BOOKING_STATUS_CONFIRMED)->count();
        $completedappointments = DoctorPatientAppointment::where('doctor_id', $doctorId)->where('booking_status', BOOKING_STATUS_COMPLETED)->count();
        $cancelledappointments = DoctorPatientAppointment::where('doctor_id', $doctorId)->where('booking_status', BOOKING_STATUS_CANCELLED)->count();
        $appointments = DoctorPatientAppointment::where('doctor_id', $doctorId)->orderBy('id', 'desc')->take(5)->get();
        $NewConsultation = DoctorPatientAppointment::where('doctor_id', $doctorId)->where('booking_type', 'New Consultation')->count();
        $FollowupConsultation = DoctorPatientAppointment::where('doctor_id', $doctorId)->where('booking_type', 'Follow-up Consultation')->count();
        $SecondOpinion = DoctorPatientAppointment::where('doctor_id', $doctorId)->where('booking_type', 'Second Opinion')->count();
        $OnlineConsultation = DoctorPatientAppointment::where('doctor_id', $doctorId)->where('booking_type', 'Online Consultation')->count();
        $EmergencyConsultation = DoctorPatientAppointment::where('doctor_id', $doctorId)->where('booking_type', 'Emergency Consultation')->count();
        return view('doctor.dashboard', compact('page_heading',
        'totalappointments','pendingappointments','confirmappointments','completedappointments','cancelledappointments',
        'appointments', 'doctor',
        'NewConsultation',
    ...
    public function notifications(){
        ...
        return view('doctor.notifications', compact('page_heading','module_heading'));
    }
