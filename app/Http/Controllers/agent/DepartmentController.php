...
class DepartmentController extends Controller
{
    ...
    {  
        ...
        return view('agent.departmentlist',compact('page_heading', 'module_heading', 'hospital_id', 'hospital', 'department_list'));
    }
    ...
    public function create($id = '')
    {
        ...
        return view('agent.createDepartment', compact('page_heading', 'module_heading', 'id', 'hospital_id', 'row', 'departments'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $o_data['redirect'] = route('agent.departments');
            ...
            if ($check) {
                ...
                if ($id) {
                    ...
                    try {
                        ...
                        $departmentHospital->save();
                        $name = $departmentHospital->department->title;
                        activity_log('department_updated', "$name Created");
                        DB::commit();
                        $status = "1";
    ...
    public function edit($id)
    {
        ...
        if ($department) {
            ...
            return view("agent.createdepartment", compact('page_heading','module_heading', 'departments','selected_department_id','mode','id','department_manager','department_name','email','phone','dial_code'));
         } else {
             abort(404);
         }
    }
