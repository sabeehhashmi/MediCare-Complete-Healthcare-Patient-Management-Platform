...
class LoginController extends Controller
{
    ...
    public function login()
    {
     ...
     //  dd("sfsdfsdf");
        ...
        if (Auth::check() && (Auth::user()->role == AGENT_ROLE)) {
    ...
    public function Register()
    {
       ...
       $country_list =  CountryModel::where(['active'=>1])->get();
        ...
        // echo Hash::make('Hello@1985');
        return view('agent.register',compact('country_list','emirates_list','area_list'));
    }
...
public function verifyLoginOtp(Request $request)
{
    ...
    // dd(1234);   
        ...
        if ($validator->fails()) {
            ...
            // Validate request
            if (Auth::attempt(['email' => $request->email, 'password' => $request->password, 'deleted' => 0, 'role' => AGENT_ROLE])) {
                if (Auth::check()) {
    ...
    {
        return view('agent.terms_and_conditions');
    }
