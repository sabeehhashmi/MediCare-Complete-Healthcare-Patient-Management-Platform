...
class HospitalDashboardController extends Controller
{
    ...
    public function dashboard()
    {
       ...
       return view('agent.dashboard', compact('page_heading','module_heading',
    ...
    'NewConsultation',
        ...
        'SecondOpinion',
        'OnlineConsultation',
        'EmergencyConsultation','totalDoctors','totalHospitals'));
    }

    public function notifications(){
        $page_heading = "Notifications";
        $module_heading = "Notifications";
        return view('agent.notifications', compact('page_heading','module_heading'));
    }
