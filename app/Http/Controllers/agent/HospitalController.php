...
class HospitalController extends Controller
{
    public function index(){
        ...
        return view('agent.hospitals.index',compact('page_heading','module_heading'));
    }
    ...
    public function save(REQUEST $request)
    {
        ...
        $errors     = [];
        // dd($request->all());
        $o_data['redirect'] = route('agent.hospitals');
        ...
        $rules = [
            ...
            'direct_phone'=>'nullable|numeric|digits_between:7,12',
        ];
...
//                            HospitalImage::where('hospital_id', $hospital->id)->delete();
        ...
        ->addColumn('action', function($user) {
             $action = '<div class="dropdown mt-4 mt-sm-0">
               ...
               // if (get_user_permission('hospitals', 'u')) {
                $action.='<a class="dropdown-item complete-link" href="'.route('agent.hospitals.hospitalDetails',['id'=>$user->id]).'">View Hospital </a>';
                $action.='<a class="dropdown-item complete-link" href="'.route('agent.hospitals.edit',['id'=>$user->id]).'">Edit Hospital </a>';
               // }
                $action .= '<a class="dropdown-item" data-role="unlink"
                            ...
                            href="' . route('agent.hospitals.delete', ['id' => encrypt($user->id)]) . '">
                            <i class="flaticon-delete-1"></i> Delete Hospital
                          </a>';
                          $action.='<a class="dropdown-item complete-link" href="' . route('agent.doctors', ['hospital_id' => $user->id]) . '">Doctors </a>';
                //if (get_user_permission('departments', 'r')) {
                    $action.='<a class="dropdown-item complete-link" href="'.route('agent.hospitals.departments',['id'=>$user->id]).'">View Departments </a>';
               // }
                ...
                //}
                   ...
                   $action.='<a class="dropdown-item complete-link" href="'.route('agent.appointments',['hospital_id'=>$user->id]).'">View Appointments</a>';


                //if (get_user_permission('insurence_policy', 'r')) {
                    $action.='<a class="dropdown-item complete-link" href="'.route('agent.hospitals.insurances',['id'=>$user->id]).'">View Insurance </a>';
                //}
    ...
    public function hospitalDetails($id){
       ...
       // printr($insurences); exit;
        return view('agent.hospitals.viewhospital',compact('page_heading','module_heading','hospital','insurences'));
    }
    ...
    public function doctors($id){
        ...
        return view('agent.doctors.index',compact('page_heading', 'hospital_id', 'hospital'));
    ...
    public function departments($id){
        ...
        return view('agent.hospitals.departments',compact('page_heading', 'hospital_id', 'hospital', 'department_list', 'module_heading'));
    }
    ...
    public function createDepartment($hospital_id, $id = '')
    {
        ...
        return view('agent.hospitals.createDepartment', compact('page_heading', 'id', 'hospital_id', 'row', 'departments'));
    }
    ...
    public function saveDepartment(REQUEST $request)
    {
        ...
        $o_data['redirect'] = route('agent.hospitals.departments', $request->hospital_id ?? null);
    ...
    public function appointments($id){
        ...
        $hospital = Hospital::find($hospital_id);
        $page_heading.= $hospital ? ('- '.$hospital->name_en) : '';
        return view('agent.hospitals.appointment',compact('page_heading','hospital','hospital_id'));
    }
        ...
        ->addColumn('action', function($user) {
             $action = '<div class="dropdown mt-4 mt-sm-0">
                ...
                if (get_user_permission('patients', 'r')) {
                    $action .= '<a class="dropdown-item complete-link" href="'.route('agent.hospitals.edit_appointment', ['hospital_id' => $user->hospital_id ?? null, 'id' => $user->id]).'">Edit</a>';
    ...
    public function create_appointment($hospital_id, $id = '')
    {
        ...
        $page_heading.= $hospital ? ('- '.$hospital->name_en) : '';
        // dd($row->toArray());
        return view('agent.hospitals.make_appointment', compact(
            'page_heading',
            'id',
            'patients',
            'hospital_id',
    ...
    public function saveAppointment(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            $status = "1";
            $o_data['redirect'] = route('agent.hospitals.appointments', $request->hospital);
        }
    ...
    public function insurances($id){
        ...
        return view('agent.hospitals.insurances',compact('page_heading', 'hospital_id', 'hospital', 'list'));
    ...
    public function createInsurance($hospital_id, $id = '')
    {
        ...
        return view('agent.hospitals.createInsurance', compact('page_heading', 'id', 'hospital_id', 'row', 'insurances', 'sub_insurance_list'));
    }
    ...
    public function saveInsurance(Request $request)
    {
        ...
        $o_data['redirect'] = route('agent.hospitals.insurances', $request->hospital_id ?? null);
    ...
    public function locations($id){
        ...
        return view('agent.hospitals.locations',compact('page_heading', 'hospital_id', 'hospital', 'list'));
    ...
    public function createLocation($hospital_id, $id = '')
    {
        ...
        return view('agent.hospitals.createLocation', compact('page_heading', 'id', 'hospital_id', 'row'));
    }
    ...
    public function saveLocation(Request $request)
    {
        ...
        $o_data['redirect'] = route('agent.hospitals.locations', $request->hospital_id ?? null);
