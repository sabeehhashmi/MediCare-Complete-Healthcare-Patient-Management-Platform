...
class HospitalInsuranceController extends Controller
{
    ...
    {   
        ...
        ->values(); // Reset indices for a clean array
        return view("clinic.our_insurance",  compact('page_heading', 'module_heading', 'name','hospital','insurances'));
    }
    ...
    $subinsurancepolices = SubInsurencePolicy::with('insurence_with_trashed')
        ...
        return view("clinic.createhospital_insurance", compact('page_heading','module_heading', 'id','name','insurance_id','subinsurance_id','hospital','subinsurancepolices','insurancepolices','mode','id','department_manager','department_name','email','phone','dial_code','insurances'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($check) {
            ...
            // // dd($requestParam);
            // return view("clinic.createhospital_insurance", compact('page_heading','module_heading', 'id','name','insurance_id','subinsurance_id','hospital','subinsurancepolices','insurancepolices','mode','id','department_manager','department_name','email','phone','dial_code', 'requestParam', 'duplicate_insurance'));
        }
        ...
        if ($id) {
            ...
            try {
                ...
                return redirect()->route('clinic.ourinsurance')->with('error', $message);
            }
        } else {
            DB::beginTransaction();
            try {
        ...
        return redirect()->route('clinic.ourinsurance')->with('success', 'Insurance information saved successfully.');
    }
    ...
    public function edit($id)
    {
        ...
        if ($insurance) {
            ...
            return view("clinic.createhospital_insurance", compact('page_heading','mode','id','hospital','insurancepolices','subinsurancepolices','hospitalId','name','insurance_id','subinsurance_id'));
         } else {
             abort(404);
         }
    }
    ...
    public function destroy($id)
    {
       ...
       return redirect()->route('clinic.ourinsurance')->with('success', 'Insurance removed  successfully.');
