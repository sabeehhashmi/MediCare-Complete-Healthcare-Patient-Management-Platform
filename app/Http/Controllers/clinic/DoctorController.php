...
class DoctorController extends Controller
{
    public function index(Request $request){
        ...
        return view('clinic.doctors.doctors',compact('page_heading','module_heading', 'doctors'));
    }
    ...
    public function detail($id){
        ...
        return view('clinic.doctordetail',compact('page_heading','module_heading','doctor', 'totalappointments', 'pendingappointments', 'confirmappointments', 'completedappointments', 'cancelledappointments', 'insurances'));
    }
...
// dd($departments);
        ...
        return view('clinic.doctors.createdoctor',compact(
    ...
    public function appointments(Request $request,$id){
        ...
        return view('clinic.appointment', compact(
            'page_heading','module_heading', 
            // 'todayAppointments', 
    ...
    public function availability($id){
        ...
        return view('clinic.availability',compact('page_heading','module_heading','time_slot',
        'sunday_availability',
        'sunday_time_slot',
        'monday_availability',
        'monday_time_slot',
    ...
    public function instantAppointment($id){
        ...
        return view('clinic.instantAppointment',compact('page_heading','module_heading',
        'doctor_id', 'doctor'));
    }
    public function temporaryUnavailable($id){
        ...
        return view('clinic.temporaryUnavailable',compact('page_heading','module_heading','time_slot',
        'doctor_id', 'doctor'));
    ...
    public function holiday($id){
        ...
        $doctor_id = $id;
        $doctor = Doctor::find($doctor_id);
        return view('clinic.holiday',compact('page_heading','module_heading','doctor_id', 'doctor'));
    }
    public function save(REQUEST $request)
    {
        ...
        $o_data     = [];
        $errors     = [];
        $o_data['redirect'] = route('clinic.doctors');
        $rules = [
            'first_name' => 'required',
            'last_name' => 'required',
