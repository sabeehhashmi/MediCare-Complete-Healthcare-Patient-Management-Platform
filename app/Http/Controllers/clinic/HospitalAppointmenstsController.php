...
class HospitalAppointmenstsController extends Controller
{
    ...
    public function index(Request $request) {
        $page_heading = "Clinic Appointments";
        ...
        return view('clinic.totalappointments', compact(
        ...
        ->addColumn('action', function($user) {
             $action = '<div class="dropdown mt-4 mt-sm-0">
                ...
                // if (get_user_permission('patients', 'r')) {
                    $action .= '<a class="dropdown-item complete-link" href="'.route('clinic.edit_appointment', ['id' => $user->id]).'">Edit</a>';
    ...
    public function create_appointment($id = '')
    {
        ...
        // dd($row->toArray());
        return view('clinic.createAppointment', compact(
            'page_heading', 'module_heading',
            'id',
            'patients',
            'hospital_id',
    ...
    public function saveAppointment(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            $status = "1";
            $o_data['redirect'] = route('clinic.hospitalAppointments');
        }
    ...
    public function saveDrAppointment(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            $status = "1";
            $o_data['redirect'] = route('clinic.appointments', $doctor->doctor_id);
        }
    ...
    public function reports(Request $request)
    {
        ...
        $appointments = $appointmentsQuery->where($whereClauses)->orderBy('id', 'desc')->paginate(10);
        return view('clinic.reports', compact('page_heading','doctors','departments','appointments', 'hospital', 'module_heading'));
    }
    
    public function booking_details($id){
        
        $appointment = DoctorPatientAppointment::where('id', $id)->with('followups','docs','clinicalSummary')->first();
        ...
        return view('clinic.appointment_detail',compact('id','appointment', 'module_heading',
...
->first();
    ...
    return view('clinic.history',compact('id','appointments', 'module_heading',
