...
class ClinicDashboardController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $appointments = DoctorPatientAppointment::whereIn('doctor_id', $doctorIds)->orderBy('id', 'desc')->take(5)->get();
       ...
       $EmergencyConsultation = DoctorPatientAppointment::where('hospital_id', $hospitalId)->where('booking_type', 'Emergency Consultation')->count();
        ...
        return view('clinic.dashboard', compact('page_heading','module_heading',
        'totaldepartments','totaldoctors','totalappointments','pendingappointments',
        'confirmappointments','completedappointments','cancelledappointments',
        'appointments',
        'NewConsultation',
    ...
    public function notifications(){
        ...
        return view('clinic.notifications', compact('page_heading','module_heading'));
    }
