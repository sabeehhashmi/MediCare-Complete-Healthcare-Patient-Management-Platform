            ...
            <div class="card">
                <div class="p-4 pt-0">
                    <div class="d-flex justify-content-between align-items-center mt-3">
                        ...
                        <a href="{{route('clinic.addinsurance')}}" style="margin-left: auto;" class="btn btn-outline-primary waves-effect waves-light">Add Insurance</a>
                    </div>
                    <hr class="my-3">
                                    ...
                                    <td>
                                        <span>
                                            <div class="d-flex gap-2 justify-content-end">
                                                ...
                                                <a href="{{route('clinic.deleteinsurance',['id'=>$insurance['insurance_id']])}}" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete" class="btn btn-sm btn-icon btn-secondary text-white text-danger">
