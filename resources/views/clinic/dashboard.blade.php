...
<div class="row">
    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <a href="{{route('clinic.doctors')}}" class="card bg-white">
            <div class="card-body">
                <div>
    ...
    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <a href="{{route('clinic.totalappointments')}}" class="card bg-white">
            <div class="card-body">
                <div>
                    <div class="d-flex align-items-center">
                        <div class="avatar">
    ...
    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <a href="{{route('clinic.totalappointments', ['booking_status' => BOOKING_STATUS_PENDING])}}" class="card bg-white">
            <div class="card-body">
                <div>
                    <div class="d-flex align-items-center">
                        <div class="avatar">
    ...
    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <a href="{{route('clinic.totalappointments', ['booking_status' => BOOKING_STATUS_CONFIRMED])}}" class="card bg-white">
            <div class="card-body">
                <div>
                    <div class="d-flex align-items-center">
                        <div class="avatar">
    ...
    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <a href="{{route('clinic.totalappointments', ['booking_status' => BOOKING_STATUS_COMPLETED])}}" class="card bg-white">
            <div class="card-body">
                <div>
                    <div class="d-flex align-items-center">
                        <div class="avatar">
    ...
    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <a href="{{route('clinic.totalappointments', ['booking_status' => BOOKING_STATUS_CANCELLED])}}" class="card bg-white">
            <div class="card-body">
                <div>
                    <div class="d-flex align-items-center">
                        <div class="avatar">
    ...
    <div class="col-md-6 col-xl-3 mb-4">
        <a href="{{route('clinic.totalappointments', ['booking_type' => 'New Consultation'])}}"  class="card">
            <div class="card-body">
    ...
    <div class="col-md-6 col-xl-3 mb-4">
        <a href="{{route('clinic.totalappointments', ['booking_type' => 'Follow-up Consultation'])}}"  class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
    ...
    <div class="col-md-6 col-xl-3 mb-4">
        <a href="{{route('clinic.totalappointments', ['booking_type' => 'Second Opinion'])}}"  class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
    ...
    <div class="col-md-6 col-xl-3 mb-4">
        <a href="{{route('clinic.totalappointments', ['booking_type' => 'Online Consultation'])}}"  class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
    ...
    <div class="col-md-6 col-xl-3 mb-4">
        <a href="{{route('clinic.totalappointments', ['booking_type' => 'Emergency Consultation'])}}"  class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
