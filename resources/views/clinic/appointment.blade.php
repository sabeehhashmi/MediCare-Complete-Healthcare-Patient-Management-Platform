...
<div class="card">
    <h5 class="card-header card-header d-flex justify-content-between">DR {{$page_heading}}
    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#appointment-modal-doctor">Make an Appointment</button>
</h5>
    <div class="card-body">
    ...
    <form action="{{ route('clinic.appointments', $doctor_id) }}" method="GET" id="search-form">
    <div class="row align-items-end">
        ...
        <div class="col-sm">
            ...
            <div class="d-flex mt-3 mb-3">
                ...
                <a href="{{route('clinic.appointments', $doctor_id)}}" type="button"  class=" btn btn-info waves-effect waves-light">Refresh</a>
                <a href="{{ route('clinic.appointments.export', ['doctor_id' => $doctor_id]) }}" id="export" class="btn btn-primary"><i class="mdi mdi-file-excel"></i> Export</a>
            </div>
            </div>
        </div>
                                ...
                                <td>
                                    <div class="dropdown mt-4 mt-sm-0">
                                        ...
                                        <div class="dropdown-menu">
                                                <a class="dropdown-item" href="{{route('clinic.appointmentdetail',['id'=>$appointment->id])}}">View Appointment</a>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#appointment-modal-doctor #booking_date_appointment').on("change", function () {
            checkAvailibility2("{{$doctor_user_id}}", $('#appointment-modal-doctor #booking_date_appointment').val());
        });
