...
<div class="position-relative mb-5">
    <div class="card">
        <div class="card-body">
            <form id="availabilityForm" method="post" action="{{route('clinic.temporaryUnavailableSave')}}" class="registerform" autocomplete="off">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="text-center d-flex gap-2">
                        ...
                        <a type="button" class="btn btn-delete" href="{{route('clinic.temporaryunavailable', $doctor->id)}}">Clear All</a>
                    </div>
                </div>
            </div>
            </form>
...
<script>
    function checkUnAvailibility(date){
        ...
        if(date){
            $.ajax({
                type: "POST",
                url: "{{ url('clinic/check_doctor_unavailability') }}",
                data:{
