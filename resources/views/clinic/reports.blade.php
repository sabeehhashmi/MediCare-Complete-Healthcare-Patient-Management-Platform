...
<div class="card">
    <div class="card-body">
        ...
        <form action="{{ route('clinic.reports') }}" method="GET" id="search-form">
                ...
                <div class="col-sm">
                    <div class="d-flex justify-content-between">
                        <div class="d-flex mt-3 mb-3">
                            ...
                            <a href="{{route('clinic.reports')}}" type="button"  class=" btn btn-info waves-effect waves-light">Refresh</a>
