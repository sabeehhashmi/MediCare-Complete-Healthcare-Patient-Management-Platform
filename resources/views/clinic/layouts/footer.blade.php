...
<footer class="footer">
                                                ...
                                                <a href="#">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            ...
                                                            @endphp
                                                            <span class="text-muted font-size-13"><span id="modal-hospital-address">{{$hospital->address}}</span></span>
                                                        </div>
        ...
        <div class="modal fade" id="upload-docs" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-md modal-dialog-scrollable modal-dialog-centered">
                ...
                <div class="modal-body">
                    <form method="post" action="{{route('clinic.uploadAppointmentDocs')}}" id="confirm_docs_upload_form" class="custom-form"
        ...
        <div class="modal fade" id="reschedule-modal" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-scrollable modal-dialog-centered">
                ...
                <div class="modal-body">
                    <form method="post" action="{{route('clinic.rescheduleAppointment')}}" id="reschedule_appointment_form" class="custom-form">
                        @csrf
        ...
        <div class="modal fade" id="appointment-modal" tabindex="-1" aria-labelledby="appointmentModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-scrollable modal-dialog-centered">
                ...
                <div class="modal-body">
                    <form method="post" id="book_appointment_form" action="{{route('clinic.saveAppointment')}}" class="custom-form">
                    @csrf    
                    <div class="row">
        ...
        <div class="modal fade" id="appointment-modal-doctor" tabindex="-1" aria-labelledby="appointmentModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-scrollable modal-dialog-centered">
                ...
                <div class="modal-body">
                    <form action="{{route('clinic.saveDrAppointment')}}" class="custom-form" id="book_appointment_form_dr">
                        @csrf
                        <input type="hidden" value="{{$doctor_user_id ?? null}}" name="doctor" id="">
                        <div class="row">
                            <div class="col-12 mb-3">
                            ...
                            <div class="col-12 mb-3">
                                <label class="form-label" for="">Select Clinic </label>
                                <div class="position-relative">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div class="position-relative">
                                    <select name="patient" id="PatientSelctDR" class="select2-single" data-placeholder="Select Patient">
                                        ...
                                        @if(count($patients ?? []))
                                        @foreach($patients as $pati)
                                            <option value="{{ $pati['id'] }}" {{($patient->id ?? null) == $pati['id'] ? 'selected': '' }} data-type="{{$pati['type']}}">{{ $pati['fullname'] }}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="col-12 mb-3">
                                <label class="form-label" for="">Select Doctor </label>
                                <div class="position-relative">
                                    <select name="" id="doctorSelct1" disabled class="select2-single" data-placeholder="Select Doctor">
                                        <option></option>
                                        @if(count($doctors ?? []))
                                        @foreach($doctors as $doctor)
        ...
        <div class="modal fade" id="followup-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('clinic.saveAppointmentFollowup') }}" class="custom-form" id="appointment_followup">
                            @csrf
    ...
    $(document).ready(function() {
        ...
        $("#DepartmentSelct, #PatientSelct, #doctorSelct, #memberSelct").select2({ dropdownParent: "#appointment-modal" });
...
$('#upload-docs #confirm_docs_upload').on('click', function (e) {
    ...
    let labFiles  = $('input[name="lab_report[]"]')[0].files.length;
    let xrayFiles = $('input[name="xray[]"]')[0].files.length;

    // ❌ both empty → block submit
    if (labFiles === 0 && xrayFiles === 0) {
        App.alert(
