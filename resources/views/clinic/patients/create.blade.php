...
<div class="card mb-5">
    <div class="p-4 pt-5">
        <form id="admin_form" method="post" action="{{route('clinic.patients.save')}}" class="registerform" autocomplete="off" data-parsley-validate="true">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-4">
                    ...
                    <div class="position-relative input-custom-icon">
                        <input type="text" name="dob" value="{{$patient->dob ?? null}}" required data-jqv-required="true" class="form-control flatpicker-input" id="" placeholder="Select Date of birth" />
...
<script>
    $(document).ready(function() {
        ...
        if (parentId) {
            $.ajax({
                type: "GET",
                url: "{{ url('clinic/get-sub-insurance') }}/" + parentId,
