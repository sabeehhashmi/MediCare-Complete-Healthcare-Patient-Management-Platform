...
<div class="card mb-5">
    ...
    <div class="card-header"><a href="{{route('clinic.patients.createMember', $patient_id)}}" class="btn btn-primary" style="width: 200px;"><i class="mdi mdi-plus me-1"></i> Add Member </a></div>
                    ...
                    <tr>
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <a class="dropdown-item" href="{{route('clinic.patients.editMember', ['patient_id' => $row->user_id, 'id' => encrypt($row->id)])}}"><i class="flaticon-pencil-1"></i> Edit</a>
                                    ...
                                    @if (get_user_permission('patients', 'd'))
                                        <a class="dropdown-item" data-role="unlink"
                                            ...
                                            href="{{ route('clinic.patients.deleteMember', ['id' => encrypt($row->id)]) }}">
            ...
            <div class="mt-4">
                ...
                <div class="col-sm-12 col-md-12 pull-right">
                    <div class="dataTables_paginate paging_simple_numbers" id="example2_paginate">
                        {!! $records->appends(request()->input())->links('clinic.template.pagination') !!}
                    </div>
                </div>
            </div>
