...
<div class="card mb-5">
    ...
    <div class="card-header"><a href="{{route('clinic.patients.create')}}" class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2 "><i class="mdi mdi-plus me-1"></i> Add Patient </a></div>
    @endif
    <div class="card-body">
            ...
            <div class="row align-items-end mt-3 mx-2">
                ...
                <div class="col-sm mb-2">
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('clinic.patients.export') }}" id="export" class="btn btn-primary"><i
    ...
    <script>
        $(document).ready(function () {
            function updateExportUrl() {
                ...
                let exportUrl = "{{ route('clinic.patients.export') }}" + '?' + query;
            ...
            var table = $('#table_list11').DataTable({
                ...
                ajax: {
                    'type': 'POST',
                    'url': '{{ route("clinic.patients.load") }}',
                    'data': function (d) {
