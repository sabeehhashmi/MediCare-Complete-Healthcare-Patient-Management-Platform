...
<div class="card">
    <div class="card-body">
        <div class="position-relative">
            <div class="d-flex gap-2 justify-content-between mb-3">
                ...
                @if($hospital->is_contract_signed==1)
    ...
    <form action="{{ route('hospital.totalappointments') }}" method="GET" id="search-form">
        <div class="row align-items-end">
                ...
                <div class="position-relative select-custom-icon">
                    <select name="department_id" id="department_id" class="select2-single" data-placeholder="Select Department">
                        ...
                        @foreach($departments as $department)
                            <option value="{{ $department->id }}" {{ old('department_id', request('department_id')) == $department->id ? 'selected' : '' }}>{{ $department->title }}</option>
                        @endforeach
                    </select>
            ...
            <div class="col-sm">
                <div class="d-flex mt-3 mb-3">
                    ...
                    <a href="{{route('hospital.hospitalAppointments')}}" type="button"  class=" btn btn-info waves-effect waves-light">Refresh</a>
                    <a href="{{ route('hospital.appointments.export') }}" id="export" class="btn btn-primary"><i class="mdi mdi-file-excel"></i> Export</a>
                </div>
            </div>
        </div>
    </form>
            ...
            <div class="table-wrap" id="tableDiv">
                <div class="table-responsive">
                    ...
                    <thead>
                        ...
                        <input type="checkbox" class="form-check-input change_status" data-id="{{$appointment->id  }}"
                                    data-url="{{url('hospital/appointments/change_status')  }}"
                                   {{ $appointment->document_permission == 1 ? 'checked' : '' }}>
                    </div>
                                   </td>
                                ...
                                <td>
                                    <div class="dropdown mt-4 mt-sm-0">
                                        ...
                                        <div class="dropdown-menu">
                                                <a class="dropdown-item cancel-link" href="{{route('hospital.appointmentdetail',['id'=>$appointment->id])}}">View Appointment</a>
