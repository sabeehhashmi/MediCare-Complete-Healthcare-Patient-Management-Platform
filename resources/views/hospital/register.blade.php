...
<head>
        ...
        <meta charset="utf-8" />
        <title>Hospital Register | Mednero</title>
                            ...
                            <div class="card-body p-4"> 
                                <div class="mb-4 pb-2">
                                    <a href="" class="d-block auth-logo">
                                        <img src="assets/images/logo-mednero.png" alt="" height="60" class="auth-logo-dark me-start">
                                        <img src="assets/images/logo-mednero.png" alt="" height="60" class="auth-logo-light me-start">
                                    </a>
                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 mb-3">
                                                <div class="custom-textarea">
                                                    <label class="form-label" required for="username">Hospital Profile</label>
        ...
        if (countryId) {
            $.ajax({
                ...
                success: function (res) {
                    if (res) {
                        $('#emirate_id').empty();
                        $('#emirate_id').append('<option value="">Select City</option>');
