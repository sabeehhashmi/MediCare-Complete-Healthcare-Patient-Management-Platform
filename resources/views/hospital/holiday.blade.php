...
<div class="position-relative">
    <div class="card">
        <div class="card-body">
        <form id="holidayForm" method="post" action="{{route('hospital.holiday_save')}}" class="registerform" autocomplete="off">
            @csrf
    ...
    $(document).ready(function() {
        $('body').on('click', '#deleteHoliday', function(e) {
            ...
            App.confirm('Confirm Delete', msg, function() {
                var ajxReq = $.ajax({
                    url: "{{route('hospital.holiday_delete', encrypt($doctor->id))}}",
                    type: 'DELETE',
                    dataType: 'json',
                    data: {
                        "_token": "{{ csrf_token() }}",
