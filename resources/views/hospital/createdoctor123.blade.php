...
<div class="position-relative mb-5">
    <div class="card">
        <div class="card-body">
        <form id="doctorform" method="post" action="{{route('hospital.saveDoctor')}}" class="registerform" autocomplete="off">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-4">
                    ...
                    <div class="position-relative input-custom-icon">
                        <input type="number" class="form-control jqv-input" data-jqv-required="true" id="experiences" name="experiences" value="{{$experiences}}" maxlength="3" pattern="\d{1,3}" placeholder="Years of Experiences" />
                        <span class="bx bx-building"></span>
                    </div>
                </div>
