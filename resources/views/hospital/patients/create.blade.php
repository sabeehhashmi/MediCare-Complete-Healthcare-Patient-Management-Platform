...
<div class="card mb-5">
    <div class="p-4 pt-5">
        <form id="admin_form" method="post" action="{{route('hospital.patients.save')}}" class="registerform" autocomplete="off" data-parsley-validate="true">
            @csrf
...
<script>
    ...
    //placeholder="Enter Phone Number"    initialCountry: countryIsoCode2,
        //strictMode: true,
        geoIpLookup: "auto",
        separateDialCode: true,
