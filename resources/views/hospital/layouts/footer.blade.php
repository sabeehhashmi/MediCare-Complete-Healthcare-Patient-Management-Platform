...
<footer class="footer">
                                                ...
                                                <a href="#">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            ...
                                                            @endphp
                                                            <span class="text-muted font-size-13"><span id="modal-hospital-address">{{$hospital->address ?? null}}</span></span>
                                                        </div>
        ...
        <div class="modal fade" id="reschedule-modal" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-scrollable modal-dialog-centered">
                ...
                <div class="modal-body">
                    <form method="post" action="{{route('hospital.rescheduleAppointment')}}" id="reschedule_appointment_form" class="custom-form">
                        @csrf
        ...
        <div class="modal fade" id="upload-docs" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-md modal-dialog-scrollable modal-dialog-centered">
                ...
                <div class="modal-body">
                    <form method="post" action="{{route('hospital.uploadAppointmentDocs')}}" id="confirm_docs_upload_form" class="custom-form"
        ...
        <div class="modal fade" id="appointment-modal" tabindex="-1" aria-labelledby="appointmentModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-scrollable modal-dialog-centered">
                ...
                <div class="modal-body">
                    <form method="post" id="book_appointment_form" action="{{route('hospital.saveAppointment')}}" class="custom-form">
                    @csrf    
                    <div class="row">
                                <div class="col-12 mb-3">
            ...
            <div class="modal-dialog modal-lg modal-dialog-scrollable modal-dialog-centered">
                ...
                <div class="modal-body">
                    <form action="{{route('hospital.saveDrAppointment')}}" class="custom-form" id="book_appointment_form_dr">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                <label class="form-label" for="">Select Hospital </label>
                                <div class="position-relative">
        ...
        <div class="modal fade" id="followup-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('hospital.saveAppointmentFollowup') }}" class="custom-form" id="appointment_followup">
                            @csrf
