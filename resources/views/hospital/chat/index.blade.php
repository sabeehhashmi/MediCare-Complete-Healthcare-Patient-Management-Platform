{{-- resources/views/hospital/chat/index.blade.php --}}
...
$(document).ready(function() {
    ...
    async function init() {
        try {
            let res = await fetch('{{ route("hospital.chat.init") }}', {
                method: 'POST',
    ...
    function setupMessageListener() {
        ...
        messageListenerId = "hospital_chat_" + Date.now();
    ...
    async function handleNewMessage(message) {
        ...
        // Always refresh conversation list to update last message and badge
        await refreshConversationList();
    }
    ...
    async function loadUsers() {
        try {
            let res = await fetch('{{ route("hospital.chat.conversations") }}', {
            ...
            html += `
                <div class="conversation-item ${active}" data-uid="${chat.receiver_id}" data-name="${escapeHtml(chat.name)}" data-avatar="${chat.avatar || ''}">
                    <div class="conversation-avatar">
                        <img src="${chat.avatar || '{{ asset("hospital/assets/images/default-avatar.jpg") }}'}" onerror="this.src='{{ asset("hospital/assets/images/default-avatar.jpg") }}'">
    ...
    async function openChat(uid, name, avatar) {
        ...
        $('#chatAvatar').attr('src', avatar || '{{ asset("hospital/assets/images/default-avatar.jpg") }}');
        $('#inputArea').show();
        ...
        // Refresh conversation list to remove badge
        await refreshConversationList();
    ...
    async function sendMessage() {
        ...
        try {
            ...
            await fetch('{{ route("hospital.chat.notify") }}', {
                method: 'POST',
                headers: { 'X-CSRF-TOKEN': '{{ csrf_token() }}', 'Content-Type': 'application/json' },
