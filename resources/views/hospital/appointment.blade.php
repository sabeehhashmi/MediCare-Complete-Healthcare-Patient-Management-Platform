...
<div class="card">
    ...
    <form action="{{ route('hospital.appointments', $doctor_id) }}" method="GET" id="search-form">
    ...
    <div class="col-lg-3 col-md-6 mb-3">
        ...
        <div class="d-flex gap-2 mt-3 mb-3">
                ...
                <a href="{{route('hospital.appointments', $doctor_id)}}" type="button"  class=" btn btn-secondary waves-effect waves-light">Refresh</a>
                <a href="{{ route('hospital.appointments.export', ['doctor_id' => $doctor_id]) }}" id="export" class="btn btn-primary"><i class="mdi mdi-file-excel"></i> Export</a>
            </div>
        </div>
...
<script>
    function updateExportUrl() {
        ...
        let exportUrl = new URL(exportElement.attr('href') || "{{ route('hospital.appointments.export') }}");
