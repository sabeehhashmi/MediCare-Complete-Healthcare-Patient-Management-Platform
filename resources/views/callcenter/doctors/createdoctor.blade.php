...
<div class="position-relative mb-5">
    <div class="card">
        <div class="card-body">
            <form method="post" action="{{route('callcenter.saveDoctor')}}" class="doctorform" id="doctorform">
                @csrf
                <div class="row">
                ...
                <div class="col-12 mb-3" id="department-field">
                    ...
                    <div class="position-relative select-custom-icon">
                        <select name="departments[]" id="departments" class="select2-single jqv-input" multiple  role="select2" data-placeholder="Select Departments" multiple>
