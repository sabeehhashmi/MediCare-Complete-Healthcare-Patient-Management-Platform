...
<div class="card mb-5">
    ...
    <div class="card-header card-header d-flex justify-content-between">
        <a href="{{route('callcenter.patients.create')}}" class="btn btn-primary w-auto ml-auto"> <i class="mdi mdi-plus me-1"></i> Add Patient</a>
    </div>
            ...
            <div class="row align-items-end mt-3 mx-2">
                ...
                <div class="col-sm mb-2">
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('callcenter.patients.export') }}" id="export" class="btn btn-primary"><i
    ...
    <script>
        $(document).ready(function () {
            function updateExportUrl() {
                ...
                let exportUrl = "{{ route('callcenter.patients.export') }}" + '?' + query;
            ...
            var table = $('#table_list11').DataTable({
                ...
                ajax: {
                    'type': 'POST',
                    'url': '{{ route("callcenter.patients.load") }}',
                    'data': function (d) {
