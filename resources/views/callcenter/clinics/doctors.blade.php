...
<div class="card mb-5">
    ...
    <div class="card-header"><a href="{{route('callcenter.doctors.create', ($hospital_id ?? null))}}" class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2 "><i class="mdi mdi-plus me-1"></i> Create Doctor</a></div>
...
$(document).ready(function () {
    ...
    $('#table_list').DataTable({
        ...
        ajax: {
            'type':'POST',
            'url' : '{{ route("callcenter.doctors.load") }}',
            'data':{
                '_token': '{{csrf_token()}}',
                'hospital_id': value
            }
