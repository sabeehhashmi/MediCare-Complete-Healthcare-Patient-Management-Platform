...
<div class="position-relative mb-5">
    <div class="d-lg-flex">
    @include('callcenter.layouts.left_nav_profile')
        <!-- end chat-leftsidebar -->

        <div class="w-100 user-chat mt-4 mt-sm-0 ms-lg-3">
            <div class="card">
                <div class="p-4 pt-5">
                <form id="admin_form" method="post" action="{{route('callcenter.save_profile')}}" class="registerform" autocomplete="off">
            @csrf
            ...
            <div class="row">
                <div class="col-lg-6 mb-4">
                    ...
                    <div class="position-relative input-custom-icon">
                        <input type="text" class="form-control jqv-input" data-jqv-required="true" id="name" name="name" value="{{$name}}" placeholder="Call Center Name" />
                ...
                <div class="col-lg-6 mb-4">
                    ...
                    <div class="position-relative input-custom-icon">
                        <input type="email" class="form-control jqv-input" data-jqv-required="true" {{($email ?? null) ? 'readonly' : 'false'}} id="email" @if ($email) value={{$email}} @endif name="email" placeholder="Enter Address" />
                ...
                <div class="col-lg-6 mb-4">
                    ...
                    <div class="position-relative">
                        <input type="number" class="form-control" @if ($phone) value={{$phone}} @endif id="phone" name="phone" placeholder="Enter Phone Number" />
                ...
                <div class="col-lg-6 mb-4">
                    ...
                    <div class="position-relative input-custom-icon">
                        <input type="text" class="form-control jqv-input" data-jqv-required="true" id="website" name="website" value="{{$website}}" placeholder="Enter Website" />
                        <span class="bx bx-user"></span>
                        @error('website')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                ...
                <div class="col-12 mb-3">
                    <label class="form-label" for="username">Location</label>
                    <div class="position-relative input-custom-icon">
                        <input type="text" class="form-control jqv-input autocomplete" data-jqv-required="true" id="txt_location" name="location" value="{{$location}}" placeholder="673C+W8V - Dubai - United Arab Emirates" />
                        <span class="bx bx-building"></span>
                        @error('location')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
...
<script>
    $(document).ready(function() {
        $('#imageUpload').on('change', function() {
            ...
            $.ajax({
                url: '{{ route("callcenter.save_profile_image") }}',
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
