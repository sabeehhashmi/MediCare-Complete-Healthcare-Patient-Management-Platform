...
<div class="position-relative">
    <div class="card">
        <div class="card-body">
        <form id="instantappForm" method="post" action="{{route('callcenter.instantappointment_save')}}" class="registerform" autocomplete="off">
            @csrf
                    ...
                    <div class="col-lg-6 col-md-6 mb-3">
                        <div class="instant-appoint-date">
                            ...
                            <div class="position-relative input-custom-icon">
                                <input type="text" class="form-control flatpicker-input" disabled name="instant_appointment_date_{{$key}}" placeholder="Select Date" value="{{$formattedDate}}" />
...
<script>
    $(document).ready(function() {
        $('body').on('click', '.delete-instant', function(e) {
            ...
            var id = $(this).data('id');
            var href = '{{ url("callcenter/instantappointment_delete") }}/' + id;
