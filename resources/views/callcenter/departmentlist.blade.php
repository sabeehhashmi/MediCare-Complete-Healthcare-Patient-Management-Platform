    ...
    <div class="card mb-5">
        <div class="position-relative">
            <div class="card-header card-header d-flex justify-content-between">
                <a href="{{route('callcenter.createDepartment')}}" class="btn btn-primary w-auto ml-auto"> Add Department</a>
            </div>
            <div class="card-body">
                        ...
                        <tr>
                            ...
                            <div class="dropdown mt-4 mt-sm-0">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="{{route('callcenter.editDepartment',['hospital_id' => $hospital_id, 'id' => encrypt($row->id)])}}">Edit Department</a>
                                    ...
                                    href="{{ route('callcenter.deleteDepartment', ['id' => encrypt($row->id)]) }}" data-id="{{encrypt($row->id)}}">
                            ...
                            <!-- <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <a class="dropdown-item" href="{{ route('callcenter.editDepartment', ['hospital_id' => $hospital_id, 'id' => encrypt($row->id)]) }}">
...
<script>
    $(document).ready(function() {
        $('.delete').on('click', function(e) {
            var deleteDepartmentUrl = "{{ route('callcenter.deleteDepartment', ['id' => ':id']) }}";
            e.preventDefault();
