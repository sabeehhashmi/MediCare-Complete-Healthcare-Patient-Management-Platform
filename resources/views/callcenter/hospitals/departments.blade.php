...
<div class="card-header card-header d-flex justify-content-between">
            <a href="{{route('callcenter.hospitals.createDepartment', $hospital_id)}}" class="btn btn-primary w-auto ml-auto">Create Hospital Department</a>
        </div>
      ...
      <table class="table table-condensed table-striped" id="example2">
        <thead>
          <tr>
            ...
            <th data-colname="created_at">phone</th>
          ...
          <tr>
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                      ...
                      <a class="dropdown-item" href="{{ route('callcenter.hospitals.editDepartment', ['hospital_id' => $hospital_id, 'id' => $row->id]) }}">
                      ...
                      <a class="dropdown-item" data-role="unlink"
                        ...
                        href="{{ route('callcenter.hospitals.deleteDepartment', ['id' => encrypt($row->id)]) }}">
