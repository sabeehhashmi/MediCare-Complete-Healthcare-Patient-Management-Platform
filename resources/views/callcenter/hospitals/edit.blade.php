            ...
            <div class="row">
                <div class="col-lg-12 mb-4">
                    ...
                    <div class="position-relative input-custom-icon">
                        <input type="text" class="form-control jqv-input" data-jqv-required="true" id="name_en" name="name_en" value="{{$name}}" placeholder="Hospital Name" />
                ...
                <div class="col-12 mb-4 d-none">
                    <div class="custom-textarea">
                        <label class="form-label" for="arabi_profile">Hospital Profile(ar)</label>
