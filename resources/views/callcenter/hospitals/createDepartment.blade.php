...
<div class="card mb-5">
    <form id="admin_form" method="post" action="{{route('callcenter.hospitals.saveDepartment')}}" enctype="multipart/form-data" class="custom-form">
        <div class="card-body">
            <div class="row">
                    @csrf()
               ...
               <!--  <div class="col-lg-6 mb-4">
                    ...
                    <div class="position-relative">
                        <input type="text" class="form-control"  id="phone"  name="phone" value="{{old('phone', $row->phone ?? null)}}" placeholder="Enter Phone Number" />
                        <input type="hidden" id="dial_code" name="dial_code" value="{{old('dial_code', $row->dial_code ?? null)}}"> 
                    </div>
                </div> -->
                ...
                <div class="col-lg-6 mb-4">
                    ...
                    <div class="position-relative input-custom-icon">
                        <input type="email" class="form-control jqv-input" data-jqv-required="true" {{($row->email ?? null) ? 'readonly' : 'false'}} id="email" name="email" value="{{old('email', $row->email ?? null)}}" placeholder="Enter Email Address" />
