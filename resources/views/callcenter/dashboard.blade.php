...
<!--        <a href="{{route('callcenter.agents')}}" class="card bg-white">-->
<!--            <div class="card-body">-->
<!--                <div>-->
<!--                    <div class="d-flex align-items-center">-->
<!--                        <div class="avatar">-->
<!--                            <div class="avatar-title rounded bg-danger">-->
<!--                                <i class="bx bx-user icon font-size-22 mb-0 text-white"></i>-->
<!--                            </div>-->
<!--                        </div>-->

<!--                        <div class="flex-grow-1 ms-3">-->
<!--                            <h6 class="mb-0 font-size-15">Total Agents</h6>-->
<!--                        </div>-->
<!--                    </div>-->
<!--                    <div>-->
...
<!--    </div>-->
    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <a href="{{route('callcenter.doctors')}}" class="card bg-white">
            <div class="card-body">
                <div>
                    <div class="d-flex align-items-center">
                        <div class="avatar">
    ...
    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <a href="{{route('callcenter.hospitals')}}" class="card bg-white">
            <div class="card-body">
                <div>
                    <div class="d-flex align-items-center">
                        <div class="avatar">
    ...
    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <a href="{{route('callcenter.totalappointments')}}" class="card bg-white">
            <div class="card-body">
                <div>
                    <div class="d-flex align-items-center">
                        <div class="avatar">
    ...
    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <a href="{{ route('callcenter.totalappointments', ['booking_status' => BOOKING_STATUS_PENDING ]) }}" class="card bg-white">
            <div class="card-body">
                <div>
                    <div class="d-flex align-items-center">
                        <div class="avatar">
    ...
    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <a href="{{ route('callcenter.totalappointments', ['booking_status' => BOOKING_STATUS_CONFIRMED ]) }}" class="card bg-white">
            <div class="card-body">
                <div>
                    <div class="d-flex align-items-center">
                        <div class="avatar">
    ...
    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <a href="{{ route('callcenter.totalappointments', ['booking_status' => BOOKING_STATUS_COMPLETED ]) }}" class="card bg-white">
            <div class="card-body">
                <div>
                    <div class="d-flex align-items-center">
                        <div class="avatar">
    ...
    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <a href="{{ route('callcenter.totalappointments', ['booking_status' => BOOKING_STATUS_CANCELLED ]) }}" class="card bg-white">
            <div class="card-body">
                <div>
                    <div class="d-flex align-items-center">
                        <div class="avatar">
    ...
    <div class="col-md-6 col-xl-3 mb-4">
        <a href="{{route('callcenter.totalappointments', ['booking_type' => 'New Consultation'])}}"  class="card">
            <div class="card-body">
    ...
    <div class="col-md-6 col-xl-3 mb-4">
        <a href="{{route('callcenter.totalappointments', ['booking_type' => 'Follow-up Consultation'])}}"  class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
    ...
    <div class="col-md-6 col-xl-3 mb-4">
        <a href="{{route('callcenter.totalappointments', ['booking_type' => 'Second Opinion'])}}"  class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
    ...
    <div class="col-md-6 col-xl-3 mb-4">
        <a href="{{route('callcenter.totalappointments', ['booking_type' => 'Online Consultation'])}}"  class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
    ...
    <div class="col-md-6 col-xl-3 mb-4">
        <a href="{{route('callcenter.totalappointments', ['booking_type' => 'Emergency Consultation'])}}"  class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
