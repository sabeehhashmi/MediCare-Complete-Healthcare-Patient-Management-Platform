...
<head>
        ...
        <meta charset="utf-8" />
        <title>Service Center Panel | {{config('global.site_name')}}</title>
    ...
    <script type="module">
        ...
        const dbRef = query(ref(database, 'Callcenter'), limitToLast(5));
        ...
        function showToast(item) {
            ...
            if (item.notificationType === 'bulk_broadcast') {
                toast.href = `{{route('callcenter.notifications')}}`;
            } else {
                toast.href = `{{url('callcenter/appointmentdetail')}}/${item.order_id}`;
            }
        ...
        onValue(dbRef, (snapshot) => {
            ...
            dataArray.forEach((item) => {
                ...
                if (item.notificationType === 'bulk_broadcast') {
                    notificationItem.href = `{{route('callcenter.notifications')}}`;
                } else if (item.notificationType === 'chat_message') {
                    notificationItem.href = `{{ url('doctor/chat') }}`;
                } else {
                    notificationItem.href = `{{url('callcenter/appointmentdetail')}}/${item.order_id}`;
                }
    ...
    <style>
        ...
        .concierge-service .txt{
            font-weight: 700;
            line-height: normal;
            font-size: 12px;
        }
        .concierge-service .fi{
            color: #fff;
        }
    </style>
    ...
    <a href="#" class="concierge-service">
        <i class="fi fi-rr-ambulance icon font-size-22 mb-0"></i>
        <span class="txt">Travel & Concierge</span>
    </a>
        ...
        <div class="navbar-header">
            <div class="d-flex">
                ...
                <div class="navbar-brand-box">
                    <a href="{{route('callcenter.dashboard')}}" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="{{ asset('') }}hospital/assets/images/logo-mednero-sm.png" alt="" height="26">
                        </span>
                        <span class="logo-lg">
                            <img src="{{ asset('') }}hospital/assets/images/logo-mednero.png" alt="" height="44">
                        </span>
                    </a>

                    <a href="{{route('callcenter.dashboard')}}" class="logo logo-light">
                        <span class="logo-lg">
                            <img src="{{ asset('') }}hospital/assets/images/logo-mednero.png" alt="" height="44">
                        </span>
                        <span class="logo-sm">
            ...
            <div class="d-flex">
                ...
                <div class="dropdown d-inline-block">
                    ...
                    <div class="dropdown-menu dropdown-menu-xl dropdown-menu-end p-0"
                        ...
                        <div class="p-2 border-top d-grid">
                            <a class="btn btn-sm btn-link font-size-14 btn-block text-center h-auto" href="{{route('callcenter.notifications')}}">
                ...
                <div class="dropdown d-inline-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-end pt-0">
                            ...
                            <a class="dropdown-item" href="{{ url('callcenter/get_profile') }}"><i class="bx bx-user-circle text-muted font-size-16 align-middle me-2"></i> <span class="align-middle">Profile</span></a>
                            <a class="dropdown-item d-none" href=""><i class="mdi mdi-key-outline text-muted font-size-16 align-middle me-2"></i> <span class="align-middle">Reset Password</span></a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="{{route('callcenter.logout')}}"><i class="mdi mdi-logout text-muted font-size-16 align-middle me-2"></i> <span class="align-middle">Logout</span></a>
                        </div>
                    </div>
            </div>
        </div>
                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-end pt-0">
                            ...
                            <a class="dropdown-item" href="{{ url('callcenter/get_profile') }}"><i class="bx bx-user-circle text-muted font-size-16 align-middle me-2"></i> <span class="align-middle">Profile</span></a>
                            <a class="dropdown-item d-none" href="{{ url('callcenter/change_password') }}"><i class="mdi mdi-key-outline text-muted font-size-16 align-middle me-2"></i> <span class="align-middle">Reset Password</span></a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="{{route('callcenter.logout')}}"><i class="mdi mdi-logout text-muted font-size-16 align-middle me-2"></i> <span class="align-middle">Logout</span></a>
                        </div>
                    </div>
                    ...
                    <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
                        ...
                        <div class="collapse navbar-collapse" id="topnav-menu-content">
                            <ul class="navbar-nav">
                                ...
                                <?php $patterns = array('callcenter\/dashboard');
                                      $patterns_flattened = implode('|', $patterns);
                                ?>
                                <li class="nav-item">
                                    <a class="nav-link {{preg_match('/'.$patterns_flattened.'/', $CurrentUrl) ? 'active' : null}}" href="{{route('callcenter.dashboard')}}">
                                        <i class="bx bx-home-alt icon nav-icon"></i>
                                        <span data-key="t-dashboards">Dashboard</span>
                                    </a>
                                </li>
                                <?php $patterns = array('callcenter\/hospitals');
                                      $patterns_flattened = implode('|', $patterns);
                                ?>
                                <li class="nav-item"> 
                                    <a class="nav-link {{preg_match('/'.$patterns_flattened.'/', $CurrentUrl) ? 'active' : null}}" href="{{route('callcenter.hospitals')}}">
                                        <i class="bx bx-buildings icon nav-icon"></i>
                                        <span data-key="t-dashboards">Hospital</span>
                                    </a>
                                </li>
                                
                                <?php $patterns = array('callcenter\/clinics');
                                      $patterns_flattened = implode('|', $patterns);
                                ?>
                                <li class="nav-item">
                                    <a class="nav-link {{preg_match('/'.$patterns_flattened.'/', $CurrentUrl) ? 'active' : null}}" href="{{route('callcenter.clinics')}}">
                                        <i class="bx bx-building icon nav-icon"></i>
                                        <span data-key="t-dashboards">Clinic</span>
                                    </a>
                                </li>
                                <!-- <?php $patterns = array('callcenter\/departments','callcenter\/adddepartment','callcenter\/editdepartment');
                                      $patterns_flattened = implode('|', $patterns);
                                ?> -->
                                <!-- <li class="nav-item">
                                    <a class="nav-link {{preg_match('/'.$patterns_flattened.'/', $CurrentUrl) ? 'active' : null}}" href="{{route('callcenter.departments')}}">
                                        <i class="fi fi-rr-bed-alt icon nav-icon custom-icon" style="font-size: 1.0rem;"></i>
                                        <span data-key="t-dashboards">Department</span>
                                    </a>
                                </li> -->
                                <?php $patterns = array('callcenter\/doctors','callcenter\/doctordetail','callcenter\/addoctor',   'callcenter\/appointments','callcenter\/availability','callcenter\/temporaryunavailable','callcenter\/editdoctor','callcenter\/holiday','callcenter\/instantappointment');
                                      $patterns_flattened = implode('|', $patterns);
                                ?>
                                <li class="nav-item">
                                    <a class="nav-link {{preg_match('/'.$patterns_flattened.'/', $CurrentUrl) ? 'active' : null}}" href="{{route('callcenter.doctors')}}">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('callcenter.patients.index')}}">
                                        <i class="fi fi-rr-users-medical nav-icon custom-icon" style="font-size: 1.0rem;"></i>
                                        <span data-key="t-dashboards">Patients</span>
                                    </a>
                                </li>
                                
                                <?php $patterns = array('callcenter\/agents');
                                      $patterns_flattened = implode('|', $patterns);
                                ?>
                                <!--<li class="nav-item"> -->
                                <!--    <a class="nav-link {{preg_match('/'.$patterns_flattened.'/', $CurrentUrl) ? 'active' : null}}" href="{{route('callcenter.agents')}}">-->
                                <!--        <i class="bx bx-user icon nav-icon custom-icon"></i>-->
                                <!--        <span data-key="t-dashboards">Agents</span>-->
                                <!--    </a>-->
                                <!--</li>-->

                                <?php $patterns = array('callcenter\/hospitalAppointments');
                                      $patterns_flattened = implode('|', $patterns);
                                ?>
                                <li class="nav-item">
                                    <a class="nav-link {{preg_match('/'.$patterns_flattened.'/', $CurrentUrl) ? 'active' : null}}" href="{{route('callcenter.hospitalAppointments')}}">
                                        <i class="bx bx-calendar-event icon nav-icon"></i>
                                        <span data-key="t-dashboards">Total Appointments</span>
                                    </a>
                                </li>
                                <?php $patterns = array('callcenter\/reviews');
                                      $patterns_flattened = implode('|', $patterns);
                                ?>
                                <li class="nav-item">
                                    <a class="nav-link {{preg_match('/'.$patterns_flattened.'/', $CurrentUrl) ? 'active' : null}}" href="{{route('callcenter.reviews')}}">
                                        <i class="bx bx-calendar-event icon nav-icon"></i>
                                        <span data-key="t-dashboards">Doctor Rating Report</span>
                                    </a>
                                </li>
                                <?php $patterns = array('callcenter\/reports');
                                      $patterns_flattened = implode('|', $patterns);
                                ?>
                                <li class="nav-item">
                                    <a class="nav-link {{preg_match('/'.$patterns_flattened.'/', $CurrentUrl) ? 'active' : null}}" href="{{route('callcenter.reports')}}">
                                        <i class="bx bx-file icon nav-icon"></i>
                                        <span data-key="t-dashboards">Reports</span>
                                    </a>
                                </li>
                                <?php $patterns = array('callcenter\/chat');
                                $patterns_flattened = implode('|', $patterns);
                                ?>
                                <li class="nav-item">
                                    <a class="nav-link {{preg_match('/'.$patterns_flattened.'/', $CurrentUrl) ? 'active' : null}}" href="{{ route('callcenter.chat.index') }}">
                                ...
                                <!--<li class="nav-item">-->
                                <!--    <a class="nav-link" href="{{route('callcenter.notifications')}}">-->
                                <!--        <i class="bx bx-bell icon nav-icon"></i>-->
                                <!--        <span data-key="t-dashboards">Notification</span>-->
                                <!--    </a>-->
                                <!--</li>-->
                          
                                <?php $patterns = array('callcenter\/edit_profile','callcenter\/get_profile');
                                      $patterns_flattened = implode('|', $patterns);
                                ?>
                                <li class="nav-item">
                                    <a class="nav-link {{preg_match('/'.$patterns_flattened.'/', $CurrentUrl) ? 'active' : null}}" href="{{ url('callcenter/get_profile') }}">
