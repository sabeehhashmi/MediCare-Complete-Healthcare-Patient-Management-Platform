...
?>
        <div class="chat-leftsidebar card mb-5">
            ...
            <?php $patterns = array('callcenter\/get_profile');
                  $patterns_flattened = implode('|', $patterns);
            ?>
            <div class="mail-list">
                <a href="{{ url('callcenter/get_profile') }}" class="{{preg_match('/'.$patterns_flattened.'/', $CurrentUrl) ? 'active' : null}} border-bottom">
                ...
                <?php $patterns = array('callcenter\/edit_profile');
                  $patterns_flattened = implode('|', $patterns);
                  ?>
                <a href="{{ url('callcenter/edit_profile') }}" class="d-none {{preg_match('/'.$patterns_flattened.'/', $CurrentUrl) ? 'active' : null}} border-bottom">
                    <div class="d-flex align-items-center">
                ...
                <?php $patterns = array('callcenter\/ourinsurance');
                  $patterns_flattened = implode('|', $patterns);
                  ?>
                <!-- <a href="{{ url('callcenter/ourinsurance') }}" class="{{preg_match('/'.$patterns_flattened.'/', $CurrentUrl) ? 'active' : null}} border-bottom">
                    <div class="d-flex align-items-center">
                ...
                <?php $patterns = array('callcenter\/change_password');
                  $patterns_flattened = implode('|', $patterns);
                  ?>
                <a href="{{ url('callcenter/change_password') }}" class="d-none {{preg_match('/'.$patterns_flattened.'/', $CurrentUrl) ? 'active' : null}} border-bottom">
                    <div class="d-flex align-items-center">
