...
<footer class="footer">
                    ...
                    <div class="modal-content">
                        ...
                        <!-- <div class="modal-footer justify-content-center">
                            <div class="d-flex flex-wrap gap-2">
                                ...
                                <button type="button" class="btn btn-outline-primary waves-effect waves-light" data-bs-target="#
                                " data-bs-toggle="modal" data-bs-dismiss="modal">Reschedule</button>
        ...
        <div class="modal fade" id="reschedule-modal" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-scrollable modal-dialog-centered">
                ...
                <div class="modal-body">
                    <form method="post" action="{{route('callcenter.rescheduleAppointment')}}" id="reschedule_appointment_form" class="custom-form">
                        @csrf
            ...
            <div class="modal fade" id="appointment-modal-doctor" tabindex="-1" aria-labelledby="appointmentModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-scrollable modal-dialog-centered">
                    ...
                    <div class="modal-body">
                        <form action="{{route('callcenter.saveDrAppointment')}}" class="custom-form" id="book_appointment_form_dr">
                            @csrf
                            <div class="row">
                                <div class="col-12 mb-3">
            ...
            <div class="modal fade" id="upload-docs" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-md modal-dialog-scrollable modal-dialog-centered">
                    ...
                    <div class="modal-body">
                        <form method="post" action="{{route('callcenter.uploadAppointmentDocs')}}" id="confirm_docs_upload_form" class="custom-form"
        ...
        <div class="modal fade" id="followup-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('callcenter.saveAppointmentFollowup') }}" class="custom-form" id="appointment_followup">
                            @csrf
    ...
    $(document).ready(function() {
        ...
        $("#DepartmentSelct,#hospitalSelct,#is_urgent, #PatientSelct, #doctorSelct, #memberSelct, #bookTypeSelect").select2({ dropdownParent: "#appointment-modal" });
        $("#PatientSelctDR, #doctorSelct1, #hospitalSelctDR, #bookTypeSelect").select2({ dropdownParent: "#appointment-modal-doctor" });
