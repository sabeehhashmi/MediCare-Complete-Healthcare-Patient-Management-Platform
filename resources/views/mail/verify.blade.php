                                                                    ...
                                                                    <tr>
                                                                        <td valign="top" style="padding-bottom: 0px;">
                                                                            <div  style="color:#000;font-family: Roboto,RobotoDraft,Helvetica,Arial,sans-serif;font-size:14px;line-height:150%;text-align:left;margin-top: 0px">
                                                                                <h4 style="font-weight: 600; font-size: 18px; color: #000;margin-top: 0;">Welcome to Mednero ! Your Clinic/ Hospital Registration is Under Review</h4>
                                                                                <p style="margin:0 0 16px; font-size: 14px; line-height: 26px; color: #000; text-align: left;">
                                                                                    Thank you for registering with us. Our dedicated team is reviewing your request and will respond to you shortly.
                                                                                </p>
                                                                                <p style="margin:0 0 16px; font-size: 14px; line-height: 26px; color: #000; text-align: left;">
                                                                                    In the meantime, please verify your email address by clicking <a href="{{ $verificationUrl }}" target="_blank" style="color: #1baeff">Here</a> to ensure a smooth onboarding process.
                                                                                </p>
                                                                                
                                                                                <p style="margin:0 0 16px; font-size: 14px; line-height: 26px; color: #000; text-align: left;">
                                                                                    Best regards,
                                                                                    <br>
                                                                                    <b>The Mednero Team</b>
                                                                                </p>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
