                                                                    ...
                                                                    <tr>
                                                                        <td valign="top" style="padding-bottom: 0px;">
                                                                            <div  style="color:#000;font-family: Roboto,RobotoDraft,Helvetica,Arial,sans-serif;font-size:14px;line-height:150%;text-align:left;margin-top: 0px">
                                                                                <h4 style="font-weight: 600; font-size: 18px; color: #000;margin-top: 0;">Welcome to Mednero! Your Registration is Under Review</h4>
                                                                                <p style="margin:0 0 16px; font-size: 14px; line-height: 26px; color: #000; text-align: left;">
                                                                                    Dear {{$user->name}}
                                                                                </p>
                                                                                <p style="margin:0 0 16px; font-size: 14px; line-height: 26px; color: #000; text-align: left;">
                                                                                    Thank you for registering with us. Our dedicated team is currently reviewing your request and will respond to you shortly. 
                                                                                </p>
                                                                                <p style="margin:0 0 16px; font-size: 14px; line-height: 26px; color: #000; text-align: left;">
