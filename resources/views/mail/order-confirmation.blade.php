                                                                            ...
                                                                            <div style="color:#333;font-family: Roboto,RobotoDraft,Helvetica,Arial,sans-serif;font-size:14px;line-height:150%;text-align:left;">
                                                                                ...
                                                                                <div style="text-align: center; margin-bottom: 20px;">
                                                                                    <svg width="60" height="60" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                        <circle cx="12" cy="12" r="12" fill="#1baeff" opacity="0.2"/>
                                                                                        <circle cx="12" cy="12" r="10" fill="#1baeff" opacity="0.4"/>
                                                                                        <path d="M8 12L11 15L16 9" stroke="#1baeff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                                                                    </svg>
                                                                                </div>
                                                                                
                                                                                <h4 style="font-weight: 600; font-size: 20px; color: #1baeff; margin-top: 0; text-align: center;">Payment Successful!</h4>
                                                                                
                                                                                <p style="margin:0 0 16px; font-size: 16px; line-height: 26px; color: #333; text-align: center;">
                                                                                    Thank you for your order, <strong>{{$user->name}}</strong>!
                                                                                </p>
                                                                                
                                                                                <!-- Order Details Box -->
                                                                                <div style="margin: 30px 0; background: #e6f3ff; padding: 20px; border-radius: 8px; border-left: 4px solid #1baeff;">
                                                                                    <h4 style="margin-top: 0; margin-bottom: 15px; color: #1baeff; font-size: 16px;">Order Details:</h4>
                                                                                    ...
                                                                                    <table style="width: 100%; font-size: 14px; line-height: 24px;">
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td style="padding: 5px 0; color: #333; font-weight: 500; word-break: break-word;">{{$order->payment_intent_id}}</td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </div>
                                                                                
                                                                                <!-- Order Items -->
                                                                                <h4 style="color: #1baeff; font-size: 16px; margin: 20px 0 10px;">Order Items:</h4>
                                                                                ...
                                                                                <div style="margin-top: 20px; border-top: 2px solid #e6f3ff; padding-top: 15px;">
                                                                                    <table style="width: 100%; font-size: 14px;">
                                                                                        ...
                                                                                        <tr style="font-weight: bold;">
                                                                                            <td style="padding: 10px 0 5px; color: #333; font-size: 16px;">Total:</td>
                                                                                            <td style="padding: 10px 0 5px; text-align: right; color: #1baeff; font-size: 18px;">AED {{number_format($order->total, 2)}}</td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </div>
                                                                                ...
                                                                                <div style="margin: 30px 0; padding: 15px; background: #f8f9fa; border-radius: 8px;">
                                                                                    <h4 style="color: #1baeff; font-size: 16px; margin: 0 0 10px;">Delivery Address:</h4>
                                                                                    <p style="margin: 0; color: #333; line-height: 24px;">
                                                                                ...
                                                                                <div style="margin: 20px 0; padding: 10px; background: #fff3cd; border-radius: 5px;">
                                                                                    <p style="margin: 0; color: #856404;"><strong>Notes:</strong> {{$order->notes}}</p>
                                                                                </div>
                                                                                @endif
