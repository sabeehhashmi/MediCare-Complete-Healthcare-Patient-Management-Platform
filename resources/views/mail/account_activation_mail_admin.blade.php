                                                                    ...
                                                                    <tr>
                                                                        <td valign="top" style="padding-bottom: 0px;">
                                                                            <div  style="color:#000;font-family: Roboto,RobotoDraft,Helvetica,Arial,sans-serif;font-size:14px;line-height:150%;text-align:left;margin-top: 0px">
                                                                                <h4 style="font-weight: 600; font-size: 18px; color: #000;margin-top: 0;">Account Activation Request: {{$user->name}}</h4>
                                                                                <p style="margin:0 0 16px; font-size: 14px; line-height: 26px; color: #000; text-align: left;">
                                                                                    A new registration for {{$user->name}}, with the email address {{$user->email}}, is pending your approval.
                                                                                </p>
                                                                                <p style="margin:0 0 16px; font-size: 14px; line-height: 26px; color: #000; text-align: left;">
                                                                                    Please review and approve the registration at your earliest convenience.
                                                                                </p>
