                                                ...
                                                <tr>
                                                    <td valign="top" style="padding-bottom: 0px;">
                                                        ...
                                                        <div  style="color:#333;font-family: Roboto,RobotoDraft,Helvetica,Arial,sans-serif;font-size:14px;line-height:150%;text-align:left;margin-top: 0px">
                                                            <h4 style="font-weight: 600; font-size: 18px; color: #1baeff;margin-top: 0;">Mednero Verification</h4>
                                                            <p style="margin:0 0 16px; font-size: 14px; line-height: 26px; color: #333; text-align: left;">
                                                                Hi {{$user->name}},
                                                            </p>
                                                            <p style="margin:0 0 16px; font-size: 14px; line-height: 26px; color: #333; text-align: left;">
                                                                @if($type=='temp')
                                                                    Thank you for using Mednero. Your OTP is <strong style="color: #1baeff; font-size: 24px;">{{$user->email_otp}}</strong> and valid for 10 minutes.
                                                                @else
                                                                Thank you for using Mednero. Your OTP is <strong style="color: #1baeff; font-size: 24px;">{{$user->user_email_otp}}</strong> and valid for 10 minutes.
                                                                @endif
                                                            </p>
                                                            
                                                            <!-- OTP Box Style (Optional) -->
                                                            <div style="margin: 25px 0; text-align: center;">
                                                                <span style="display: inline-block; background: #e6f3ff; color: #1baeff; font-size: 32px; font-weight: bold; letter-spacing: 8px; padding: 15px 25px; border-radius: 8px; border: 2px solid #1baeff;">
                                                                    @if($type=='temp')
                                                                        {{$user->email_otp}}
                                                                    @else
                                                                        {{$user->user_email_otp}}
