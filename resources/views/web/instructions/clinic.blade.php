    ...
    <div class="container-fluid cms-page">
        <div class="row justify-content-center">
            ...
            <div class="col-12 text-primary text-center mb-4 mt-4">
                <h1>User Instructions Clinic Panel</h1>
            </div>
            <div class="col-lg-3">
                <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <button class="nav-link text-start" id="v-pills-managing-doctor-reports-tab" data-bs-toggle="pill" data-bs-target="#v-pills-managing-doctor-reports" type="button" role="tab" aria-controls="v-pills-managing-doctor-reports" aria-selected="false">Managing Reports</button>
            ...
            <div class="col-lg-9">
                <div class="tab-content" id="v-pills-tabContent">
                    ...
                    <div class="tab-pane fade" id="v-pills-managing-doctor-reports" role="tabpanel" aria-labelledby="v-pills-managing-doctor-reports-tab" tabindex="0">
