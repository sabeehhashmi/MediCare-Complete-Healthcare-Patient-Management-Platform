                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                        ...
                        <div class="card">
                            <div class="card-body p-4 text-center"> 
                                <img src="{{asset('/')}}admin-assets/assets/images/Mednero.svg" class="img-fluid mb-4" alt="">
                                <h5 class="text-danger mx-auto" style="max-width: 320px; color: red;">Verification link already used or Expired!</h5>
