...
<head>
        ...
        <meta charset="utf-8" />
        <title>Doctor Login | Mednero</title>
        ...
        <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('') }}doctor/assets/images/favicon/favicon-16x16.png">
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        ...
                        <div class="card overflow-hidden">
                            <div class="card-body p-4"> 
                                ...
                                <div class="p-2 mt-4">
                                    <form class="form-login" action="{{ route('doctorlogin.check_login') }}" method="POST">
                                    @csrf
                                        <div class="mb-3">
                                        ...
                                        <!--    <p class="mb-0">Don’t have an account? <a href="{{url('doctor_register')}}" class="fw-medium text-primary"> Sign Up </a> </p>-->
                                        <!--</div>-->
                                    </form>
                                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="forgot-password-form" method="POST" action="{{url('forgot-password')}}">
                    @csrf
                    <input type="hidden" name="role" value="{{DOCTOR_ROLE}}">
                    <div class="mb-3">
                        <label class="form-label" for="username">Email</label>
                        <div class="position-relative input-custom-icon">
                    ...
                    <div class="mt-3 text-center">
                    <p class="mb-0 d-none">Don’t have an account? <a href="{{ url('doctor_register') }}" class="fw-medium text-primary"> Sign Up </a> </p>                    </div>
                </form>
            </div>
        </div>
        <!-- /.modal-content -->
...
<div class="modal fade resetpassword" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    ...
    $.ajax({
        type:'POST',
        url: "{{ route('doctorlogin.check_login') }}",
        data:{
