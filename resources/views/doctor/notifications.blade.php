...
<script type="module">
    ...
    const dbRef = ref(database, 'Doctor/'+hopital_user_id);
    ...
    function renderNotifications(data) {
        ...
        dataArray.forEach((item) => {
           ...
           if(item.type === 'call'){
            ...
            let image = item.imageURL ? item.imageURL : '{{ URL::asset('admin-assets/assets/images/placeholder.jpg') }}';
    ...
    onValue(initialQuery, (snapshot) => {
        if(!initialLoadCompleted){
            ...
            keys.forEach(function(it){
                addedKeys.push(it);
                let updates = {};
                updates[`/Doctor/${hopital_user_id}/${it}/read`] = 1;
