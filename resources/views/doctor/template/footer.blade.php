<footer class="footer">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="flex-grow-1" style="display: flex; flex-direction: row; flex-wrap: wrap; gap: 20px; justify-content: space-between;">
                                            <h5 style="display: flex; align-items: center;" class="mb-0 font-size-15"><i class="bx bx-envelope me-2" id="modal-user-email"></i> test@example.com</h5>
                                            ...
                                            <div class="mail-list">
                                                <a href="#" class="border-bottom">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <h5 class="font-size-14 mb-0" id="modal-appointment-date">05 May 2024</h5>
        ...
        <div class="modal fade" id="upload-docs" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-scrollable modal-dialog-centered">
                ...
                <div class="modal-body">
                    <form method="post" action="{{route('doctor.uploadAppointmentDocs')}}" id="confirm_docs_upload_form" class="custom-form"
                    enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <!-- Lab Report Upload -->
                            <div class="col-md-6 mb-3 lab_upload">
                            ...
                            <!-- X-Ray Upload -->
                            <div class="col-md-6 mb-3 xray_upload">
                                <label class="form-label fw-semibold">
                                    X-Ray
        ...
        <div class="modal fade" id="reschedule-modal" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-scrollable modal-dialog-centered">
                ...
                <div class="modal-body">
                    <form method="post" action="{{route('doctor.rescheduleAppointment')}}" id="reschedule_appointment_form" class="custom-form">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-12 mb-3">
                                ...
                                <div class="position-relative">
                                    <input type="text" name="reschedule_date" class="form-control flatpicker-input" id="reschedule_date" placeholder="Select Date" />
                                </div>
                            </div>
        ...
        <div class="modal fade" id="appointment-modal" tabindex="-1" aria-labelledby="appointmentModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-scrollable modal-dialog-centered">
                ...
                <div class="modal-body">
                    <form method="post" id="book_appointment_form" action="{{route('doctor.saveAppointment')}}" class="custom-form">
                    @csrf
                    <div class="row">
         ...
         <div class="modal fade" id="followup-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('doctor.saveAppointmentFollowup') }}" class="custom-form" id="appointment_followup">
                            @csrf
