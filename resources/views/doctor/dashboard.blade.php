...
<div class="mb-5">
    ...
    <div class="row">
        <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
            <a href="{{ route('doctor.totalappointments') }}" class="card bg-white">
                <div class="card-body">
                    <div>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
            <a href="{{ route('doctor.totalappointments', ['booking_status' => BOOKING_STATUS_PENDING]) }}" class="card bg-white">
                <div class="card-body">
                    <div>
                        <div class="d-flex align-items-center">
                            <div class="avatar">
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
            <a href="{{ route('doctor.totalappointments', ['booking_status' => BOOKING_STATUS_CONFIRMED]) }}" class="card bg-white">
                <div class="card-body">
                    <div>
                        <div class="d-flex align-items-center">
                            <div class="avatar">
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
            <a href="{{ route('doctor.totalappointments', ['booking_status' => BOOKING_STATUS_COMPLETED]) }}" class="card bg-white">
                <div class="card-body">
                    <div>
                        <div class="d-flex align-items-center">
                            <div class="avatar">
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
            <a href="{{ route('doctor.totalappointments', ['booking_status' => BOOKING_STATUS_CANCELLED]) }}" class="card bg-white">
                <div class="card-body">
                    <div>
                        <div class="d-flex align-items-center">
                            <div class="avatar">
        ...
        <div class="col-md-6 col-xl-3 mb-4">
            <a href="{{route('doctor.totalappointments', ['booking_type' => 'New Consultation'])}}"  class="card">
                <div class="card-body">
        ...
        <div class="col-md-6 col-xl-3 mb-4">
            <a href="{{route('doctor.totalappointments', ['booking_type' => 'Follow-up Consultation'])}}"  class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
        ...
        <div class="col-md-6 col-xl-3 mb-4">
            <a href="{{route('doctor.totalappointments', ['booking_type' => 'Second Opinion'])}}"  class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
        ...
        <div class="col-md-6 col-xl-3 mb-4">
            <a href="{{route('doctor.totalappointments', ['booking_type' => 'Online Consultation'])}}"  class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
        ...
        <div class="col-md-6 col-xl-3 mb-4">
            <a href="{{route('doctor.totalappointments', ['booking_type' => 'Emergency Consultation'])}}"  class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                        ...
                        @foreach ($appointments as $key => $appointment)
                            <tr>
                                ...
                                <td>{{ $appointment->booking_id }} <br> 
                                    ...
                                    <!--<span class="badge rounded-pill text-bg-danger p-1 px-2 font-size-10 fw-normal">Emergency</span>-->
                                </td>
                                <td>
                                    <a href="#!" class="patient-link text-nowrap"><img src="{{ $appointment->member ? ($appointment->member->user_img_url ?? null) : ($appointment->user->user_img_url ?? null) }}" width="32" height="32" class="me-2" alt="" />{{$appointment->member ? $appointment->member->full_name : (($appointment->user->first_name ?? '') . ' ' . ($appointment->user->last_name ?? ''))}}</a>
                                </td>
                                ...
                                <td>
                                    <div class="dropdown mt-4 mt-sm-0">
                                        ...
                                        <div class="dropdown-menu">
                                                <a class="dropdown-item" href="{{route('doctor.appointmentdetail',['id'=>$appointment->id])}}">View Appointment</a>
...
<script>
    ...
    function checkAvailibility(date, selectedTime = null){
        if(date){
            $.ajax({
                type: "POST",
                url: "{{ url('doctor/check_doctor_availability') }}",
                data:{
                    'booking_date': date,
    ...
    function checkAvailibility2(date){
    ...
    $('#reschedule-modal #reschedule_date').on("change", function () {
        checkAvailibility($(this).val());
    });
    ...
    $('.reschdule-link').click(function() {
        ...
        checkAvailibility(formattedDate, booking_data.booking_time_slot);
    });
    ...
    $("#cancelAppointment").click(function(e){
        ...
        let data = new FormData(form);
         ...
         $.ajax({
           url: "{{ route('doctor.appointment_cancel') }}",
           type: "POST",
           data : data,
           dataType:"JSON",
           processData : false,
   ...
   $("#confirmAppointment").click(function(e){
        ...
        let dataconfirm = new FormData(form);
         ...
         $.ajax({
           url: "{{ route('doctor.appointment_confirm') }}",
           type: "POST",
           data : dataconfirm,
           dataType:"JSON",
           processData : false,
   ...
   $("#buttoncompleted").click(function(e){
       ...
       let dataconfirm = new FormData(form);
        ...
        $.ajax({
          url: "{{ route('doctor.apointment_completed') }}",
          type: "POST",
          data : dataconfirm,
          dataType:"JSON",
          processData : false,
