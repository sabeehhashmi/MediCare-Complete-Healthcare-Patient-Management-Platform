...
<div class="position-relative">
    <div class="card">
        <div class="card-body">
        <form id="instantappForm" method="post" action="{{route('doctor.instantappointment_save')}}" class="registerform" autocomplete="off">
            @csrf
            ...
            @endphp
                <div class="row multiple-row">
                    <div class="col-lg-6 col-md-6 mb-3">
                        <div class="instant-appoint-date">
                            <label class="form-label" for="instant_appointment_date_{{$key}}">Date</label>
                            <div class="position-relative input-custom-icon">
                                <input type="text" class="form-control flatpicker-input"  name="instant_appointment_date_{{$key}}" placeholder="Select Date" value="{{$formattedDate}}" />
                    ...
                    <div class="col-lg-4 mt-0 mt-lg-4 col-md-6 mb-3">
                      ...
                      <div class="d-flex gap-2 mt-0 mt-lg-1">
                        <a class="delete-instant btn btn-icon btn-delete"
                            ...
                            href="'.route('doctors.instantAppointmentDelete', ['id' => encrypt($appointment->id)]).'">
                ...
                <div class="row multiple-row">
                    <div class="col-lg-6 col-md-6 mb-3">
                        ...
                        <div class="position-relative input-custom-icon">
                            <input type="text" class="form-control flatpicker-input" name="instant_appointment_date[]" placeholder="Select Date" />
                            <span class="bx bx-calendar-alt"></span>
                        </div>
                    </div>
                    <div class="col-lg-4 mt-0 mt-lg-4 col-md-6 mb-3">
...
<script>
    $(document).ready(function() {
        $('body').on('click', '.delete-instant', function(e) {
            ...
            var id = $(this).data('id');
            var href = '{{ url("doctor/instantappointment_delete") }}/' + id;
                        ...
                        if (res['status'] == 0) {
                            ...
                            if (typeof res['errors'] !== 'undefined') {
                                ...
                                jQuery.each(res['errors'], function(e_field, e_message) {
                                    if(e_message=='The instant appointment date field has duplicate dates.'){
