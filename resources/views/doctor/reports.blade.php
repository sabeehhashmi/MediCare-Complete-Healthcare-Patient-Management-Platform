...
<div class="card">
    <div class="card-body">
        ...
        <form action="{{ route('doctor.reports') }}" method="GET" id="search-form">
                ...
                <div class="col-sm">
                    <div class="d-flex justify-content-between">
                        <div class="d-flex mt-3 mb-3">
                            ...
                            <a href="{{route('doctor.reports')}}" type="button"  class=" btn btn-info waves-effect waves-light">Refresh</a>
...
function updateExportUrl() {
    ...
    let exportUrl = new URL(exportElement.attr('href') || "{{ route('doctor.appointments.export') }}");
