            ...
            <div class="card-header">
                <div class="col-lg-12">
                    <div class="d-flex gap-2 justify-content-end">
                       ...
                       <button type="button"  class="btn btn-primary m-0 " data-bs-toggle="modal" data-bs-target="#addModalData">Add New Drug Direction</button>
                    </div>
                </div>
            </div>
            <div class="card-body">
...
<!-- Add New Medicine modal -->
        ...
        <div class="modal fade" id="addModalData" tabindex="-1" aria-labelledby="appointmentModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
                <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="appointmentModalLabel">Add New Drug Direction</h1>
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="_token" value="6Vnw3gGH9qhBt8CnRVRcj1UgPHZdKIxuEw0kGA2c" autocomplete="off">                    <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div class="col-12 mb-3">
                                    <label class="form-label" for="bookTypeSelect">Status </label>
                                    <div class="position-relative">
