...
<div class="card mb-5">
  ...
  <div class="card-header">
    <a href="{{route('admin.durations.create')}}" class="btn btn-primary waves-effect waves-light mb-2 me-2 "><i
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    @if (get_user_permission('special_intrests', 'u'))
                      <a class="dropdown-item" href="{{ route('admin.durations.edit', ['id' => encrypt($role->id)]) }}">
                      ...
                      <a class="dropdown-item" data-role="unlink"
                        ...
                        href="{{ route('admin.durations.delete', ['id' => encrypt($role->id)]) }}">
