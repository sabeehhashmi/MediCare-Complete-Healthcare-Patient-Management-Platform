...
@section('content')
    ...
    <div class="card mb-5">
        <!--<div class="card p-4">-->
        <form method="post" id="admin-form" action="{{ route('admin.country-of-origin.store') }}" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        <div class="col-lg-6 mb-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" data-jqv-maxlength="100" name="name" value="{{old('name')}}" required
                                       data-parsley-required-message="Enter Country Name">
                            </div>
                        </div>
