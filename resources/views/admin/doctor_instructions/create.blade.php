...
<div class="card mb-5">
    <div class="p-4 pt-5">
        <form id="admin_form" method="post"  action="{{ url('/admin/doctor_insctruction/create') }}" autocomplete="off">
            @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-4 form-group">
                            ...
                            <select name="type" class="form-control">
                                <option  value="1">Registering a healthcare provider </option>
                                <option value="2">Managing Doctors Panel  </option>
                                <option  value="3">Managing Availability of Doctors.                            </option>
                                <option  value="4"> Managing Reports in Doctor Panel </option>
