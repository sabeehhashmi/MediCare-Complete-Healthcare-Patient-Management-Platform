...
<div class="card mb-5">
    <div class="p-4 pt-5">
        <form action="{{ url('/admin/hospital_insctruction/update') }}" id="admin_form" enctype="multipart/form-data">
            @csrf
                ...
                <div class="row  d-flex justify-content-between align-items-center">
                    <div class="col-md-6 mb-4 form-group">
                        ...
                        <select name="type" class="form-control">
                            <option  <?= $faq->type == 1 ? 'selected' : '' ?> value="1">Accessing Appointments and Doctors</option>
                            <option <?= $faq->type == 2 ? 'selected' : '' ?> value="2">Managing Appointments</option>
                            <option <?= $faq->type == 3 ? 'selected' : '' ?> value="3">Managing Doctors</option>
                            <option <?= $faq->type == 4 ? 'selected' : '' ?> value="4"> Managing Doctor’s Availability</option>
                            <option <?= $faq->type == 5 ? 'selected' : '' ?> value="5">  Managing Reports</option>
                            <option <?= $faq->type == 6 ? 'selected' : '' ?> value="6">  Managing Departments </option>
