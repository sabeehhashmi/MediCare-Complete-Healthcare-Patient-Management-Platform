...
<div class="card mb-5">
    ...
    <div class="card-header"><a href="{{url('admin/hospital_insctruction/create')}}" class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2"> Create Hospital Insctruction
        </a></div>
    @endif
    <div class="card-body">
               ...
               <tr>
                   ...
                   <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <a class="dropdown-item" href="{{url('admin/hospital_insctruction/edit/'.$item->id)}}"><i class="flaticon-pencil-1"></i> Edit</a>
                                    @endif
                                    ...
                                    data-message="Do you want to remove this hospital insctruction?"
                                    href="{{ url('admin/hospital_insctruction/delete/' . $item->id) }}"><i
