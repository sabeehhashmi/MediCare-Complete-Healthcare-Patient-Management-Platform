                    ...
                    <form method="post" id="admin-form" action="{{route('admin.contact_us_setting_store')}}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-4 form-group">
                                <label>Address</label>
                                <input type="text" name="location" class="form-control jqv-input" data-jqv-required="true" value="{{$page->location}} " placeholder=" Address" required>
                            </div>
