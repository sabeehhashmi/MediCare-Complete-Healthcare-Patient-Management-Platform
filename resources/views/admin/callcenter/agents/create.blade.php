    ...
    <div class="p-4 pt-5">
        <form id="admin_form" method="post" action="{{route('admin.agents.save')}}" class="registerform" autocomplete="off">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-4">
                    <label class="form-label" for="username">Country <a href="#" title="Add more" data-bs-toggle="modal" data-bs-target="#newcountrymodel" title="Click to Add More Country">+</a></label>
                    <div class="position-relative select-custom-icon">
                ...
                <div class="col-lg-6 mb-4">
                    <label class="form-label" for="username">City / Province <a href="#" title="Add more City / Province" data-bs-toggle="modal" data-bs-target="#newemiratemodel" title="Click to Add More Cities">+</a></label>
                    <div class="position-relative select-custom-icon">
                ...
                <div class="col-lg-6 mb-4">
                    <label class="form-label" for="username">Area <a href="#" title="Add more Area" data-bs-toggle="modal" data-bs-target="#neweareamodel" title="Click to Add More Area">+</a></label>
                    <div class="position-relative select-custom-icon">
