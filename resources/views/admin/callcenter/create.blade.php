...
<div class="card mb-5">
    <div class="p-4 pt-5">
        <form id="admin_form" method="post" action="{{route('admin.callcenter.save')}}" class="registerform" autocomplete="off">
            @csrf
            <input type="hidden" value="{{$id}}" name="id">
            <div class="row">
                <div class="col-lg-6 mb-4">
                    <label class="form-label" for="username">Service Center Name</label>
                    <div class="position-relative input-custom-icon">
                        <input type="text" class="form-control jqv-input" data-jqv-required="true" id="name" name="name" value="{{$name}}" placeholder="Service Center Name" />
                ...
                <div class="col-lg-6 mb-4">
                    ...
                    <div class="position-relative auth-pass-inputgroup input-custom-icon">
                        ...
                        @if($id)
                        <input type="password" class="form-control"  id="password-input" name="password"  autocomplete="new-password">
                       @else
                ...
                <div class="col-lg-6 mb-4">
                    ...
                    <div class="position-relative input-custom-icon">
                        <input type="text" class="form-control jqv-input"  id="website" name="website" value="{{$website}}" placeholder="Enter Website" />
                        <span class="bx bx-user"></span>
                    </div>
                </div>

                <div class="col-lg-6 mb-4">
                    <label class="form-label" for="username">Country </label><a href="#" class="float-end me-2" title="Add more" data-bs-toggle="modal" data-bs-target="#newcountrymodel" title="Click to Add More Country">Add More</a>
                ...
                <div class="col-lg-6 mb-4">
                    ...
                    <div class="position-relative input-custom-icon">
                        <input type="text" class="form-control jqv-input"  @if($address) value="{{$address}}" @endif data-jqv-required="true" id="address" name="address" placeholder="Enter Address Of Organization" />
                ...
                <!-- <div class="col-lg-6 mb-4">
                    ...
                    <div class="position-relative input-custom-icon">
                        <input type="text" class="form-control jqv-input" @if ($location) value={{$location}} @endif data-jqv-required="true" id="location" name="location" placeholder="Enter location" />
                        <span class="bx bx-building"></span>
                    </div>
                </div> -->
                <div class="col-12 mb-3">
                    ...
                    <div class="position-relative input-custom-icon">
                        ...
                        <input type="text" class="form-control autocomplete jqv-input" data-jqv-required="true" placeholder="673C+W8V - Dubai - United Arab Emirates" id="txt_location"  name="location" value="{{$callcenterDetail->location ?? null}}"/>
                        <input type="hidden" id="latitude" name="latitude" value="{{$callcenterDetail->latitude ?? null}}"/>
                        <input type="hidden" id="longitude" name="longitude" value="{{$callcenterDetail->longitude ?? null}}"/>
...
var currentLat = <?php echo (isset($callcenterDetail) && $callcenterDetail->latitude) ? $callcenterDetail->latitude : 25.204819 ?>;
var currentLong = <?php echo (isset($callcenterDetail) && $callcenterDetail->longitude) ? $callcenterDetail->longitude : 55.270931 ?>;
