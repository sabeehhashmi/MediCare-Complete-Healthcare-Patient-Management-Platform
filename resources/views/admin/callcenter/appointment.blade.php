                    ...
                    <div class="row">
                            ...
                            <div class="col-lg-12 mb-3">
                                ...
                                <div class="position-relative select-custom-icon">
                                    ...
                                    <option value="{{$hospitals->id}}">{{$hospitals->name_en}}</option>
                                    @endforeach
                                    @endif
                                    </select>
                                </div>
                            ...
                            <div class="col-lg-12 mb-3">
                                ...
                                <div class="position-relative select-custom-icon">
                                    ...
                                    @foreach($doctors as $doctors)
                                        ...
                                        <option value="{{$doctors->id}}">{{$doctors->user->name}}</option>
                                    @endforeach
                                    @endif
                                    </select>
                                </div>
...
$(document).ready(function () {
   ...
   //  alert(value);
    $('#table_list').DataTable({
        ...
        ajax: {
            'type':'POST',
            'url' : '{{ route("admin.callcenter.appointmentLoadData") }}',
            'data':{
                '_token': '{{csrf_token()}}',
                'doctor_id': value
            }
    ...
    <script>
     ...
     let data = new FormData(form);
      ...
      $.ajax({
        url: "{{ route('admin.callcenter.patientAppointmentSave') }}",
        type: "POST",
        data : data,
        dataType:"JSON",
        processData : false,
