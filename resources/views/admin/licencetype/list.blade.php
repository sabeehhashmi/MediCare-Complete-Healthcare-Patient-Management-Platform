...
<div class="card mb-5">
  ...
  <div class="card-header">
    <a href="{{route('admin.licencetype.create')}}" class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2 "><i
          ...
          <tr>
            ...
            <td>
                <div class="form-check form-switch form-switch-lg mb-3" dir="ltr">
                    <input type="checkbox" class="form-check-input change_status" data-id="{{ $role->id }}"
                                data-url="{{ url('admin/licencetype/change_status') }}"
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    @if (get_user_permission('licencetype', 'u'))
                      <a class="dropdown-item" href="{{ route('admin.licencetype.edit', ['id' => encrypt($role->id)]) }}">
                        <i class="flaticon-pencil-1"></i> Edit
                      </a>
                      @endif

                      @if (get_user_permission('licencetype', 'd'))
                      <a class="dropdown-item" data-role="unlink"
                        data-message="Do you want to remove the licencetype?  This may be linked with other sections"
                        href="{{ route('admin.licencetype.delete', ['id' => encrypt($role->id)]) }}">
