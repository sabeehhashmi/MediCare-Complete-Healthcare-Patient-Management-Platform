...
<div class="card mb-5">
  ...
  <div class="card-header">
    <a href="{{route('admin.sub_insurence_policy.create')}}" class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2 "><i
          ...
          <tr>
            ...
            <td>
                <div class="form-check form-switch form-switch-lg mb-3" dir="ltr">
                    <input type="checkbox" class="form-check-input change_status" data-id="{{ $role->id }}"
                                data-url="{{ url('admin/sub_insurence_policy/change_status') }}"
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    @if (get_user_permission('sub_insurence_policy', 'u'))
                      <a class="dropdown-item" href="{{ route('admin.sub_insurence_policy.edit', ['id' => encrypt($role->id)]) }}">
                        <i class="flaticon-pencil-1"></i> Edit
                      </a>
                      @endif

                      @if (get_user_permission('sub_insurence_policy', 'd'))
                      <a class="dropdown-item" data-role="unlink"
                        data-message="Do you want to remove the medical condition?  This may be linked with other sections"
                        href="{{ route('admin.sub_insurence_policy.delete', ['id' => encrypt($role->id)]) }}">
