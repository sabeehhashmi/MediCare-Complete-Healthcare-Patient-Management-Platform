...
<div class="card mb-5">
    ...
    <a href="{{route('admin.website_services.create')}}" class="btn btn-primary waves-effect waves-light mb-2 me-2 "><i
            ...
            <td>
                <div class="form-check form-switch form-switch-lg mb-3" dir="ltr">
                    <input type="checkbox" class="form-check-input change_status" data-id="{{ $role->id }}"
                                data-url="{{ url('admin/website_services/change_status') }}"
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    @if (get_user_permission('special_intrests', 'u'))
                      <a class="dropdown-item" href="{{ route('admin.website_services.edit', ['id' => encrypt($role->id)]) }}">
                      ...
                      <a class="dropdown-item" data-role="unlink"
                        ...
                        href="{{ route('admin.website_services.delete', ['id' => encrypt($role->id)]) }}">
