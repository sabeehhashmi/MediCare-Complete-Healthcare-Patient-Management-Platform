...
@section("content")
<div class="card mb-5">
    @if(get_user_permission('faq_for_doctors','c'))
    <div class="card-header"><a href="{{url('admin/faq-for-doctor/create')}}" class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2"> Create FAQ For Doctor</a></div>
    @endif
    <div class="card-body">
               ...
               <tr>
                   ...
                   <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <a class="dropdown-item" href="{{url('admin/faq-for-doctor/edit/'.$item->id)}}"><i class="flaticon-pencil-1"></i> Edit</a>
                                    @endif
                                    ...
                                    href="{{ url('admin/faq-for-doctor/delete/' . $item->id) }}"><i
