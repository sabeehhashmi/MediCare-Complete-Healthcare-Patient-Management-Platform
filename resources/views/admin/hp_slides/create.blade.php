...
<div class="card mb-5">
    <!--<div class="card p-4">-->
    <form method="post" id="admin-form" action="{{ url('admin/hp-slides') }}" enctype="multipart/form-data"
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-xs-12 mb-4">
                        <div class="form-group">
                            <label>Add Slide Image<span style="color:red;">*<span></span></span></label>   
                            <input required class="form-control jqv-input" id="imageUpload" type="file" name="image" accept="image/jpg, image/jpeg, image/png" /> 
