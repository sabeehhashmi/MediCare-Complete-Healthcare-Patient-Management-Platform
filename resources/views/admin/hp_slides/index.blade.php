...
<div class="card mb-5">
    ...
    <div class="card-header"><a href="{{route('admin.hp-slides.create')}}" class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2 "><i class="mdi mdi-plus me-1"></i> Create Slide</a></div>
    @endif
    <div class="card-body">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-check form-switch form-switch-lg mb-3" dir="ltr">
                                <input type="checkbox" class="form-check-input change_status" data-id="{{ $datarow->id }}"
                                            data-url="{{ url('admin/hp-slides/change_status') }}"
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <a class="dropdown-item" href="{{url('admin/hp-slides/'.$datarow->id.'/edit')}}"><i class="flaticon-pencil-1"></i> Edit</a>
                                    @endif
                                    ...
                                    href="{{ url('admin/hp-slides/' . $datarow->id) }}"><i
