...
<div class="card mb-5">
    <!--<div class="card p-4">-->
        <form method="post" id="admin-form" action="{{ route('admin.hp-slides.update',$Banner->id) }}" enctype="multipart/form-data"
                    ...
                    <div class="row">
                       ...
                       <div class="col-sm-12 col-xs-12 mb-4">
                        <div class="form-group">
                            ...
                            @if($Banner->image)
                            <div class="pb-3 pt-3">
                                <img src="{{$Banner->image }}" style="width:220px!important; height: 200px!important;">
