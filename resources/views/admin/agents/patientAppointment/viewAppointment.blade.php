...
<div class="position-relative mb-5">
    ...
    <div class="card-body">
        ...
        <div class="appointment-status-btns">
            <button type="button" class="btn btn-primary waves-effect waves-light reset-modal" data-bs-toggle="modal" data-bs-target="#confirm-appointment">Confirm</button>
            <button type="button" class="btn btn-dark waves-effect waves-light reset-modal" data-bs-toggle="modal" data-bs-target="#cancel-appointment">Cancel</button>
            <button type="button" class="btn btn-outline-primary waves-effect waves-light reset-modal" data-bs-toggle="modal" data-bs-target="#reschedule-modal">Reschedule</button>
