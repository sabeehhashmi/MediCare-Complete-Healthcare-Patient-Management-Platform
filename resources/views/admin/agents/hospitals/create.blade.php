...
<div class="card mb-5">
    <div class="p-4 pt-5">
        <form id="admin_form" method="post" action="{{route('admin.agents.hospital_save')}}" class="registerform" autocomplete="off">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-4">
                    ...
                    <div class="position-relative">
                        <input type="text" class="form-control" id="phone" name="phone" value="{{old('phone', $userPhoneNumber ?? null)}}" placeholder="Enter Phone Number" />
                        <input type="hidden" id="dial_code" name="dial_code" value="{{old('dial_code', $hospital->user->dial_code ?? null)}}" placeholder="Dial Code">
                ...
                <div class="col-lg-6 mb-4">
                    ...
                    <div class="position-relative input-custom-icon">
                        <input type="text" class="form-control jqv-input" data-jqv-required="true" id="website" value="{{old('website', $hospital->website ?? null)}}" name="website" placeholder="Enter Website" />
                ...
                <div class="col-lg-6 mb-4">
                    ...
                    <div class="position-relative">
                        ...
                        <input type="text" class="form-control" id="phone1" name="direct_phone" value="{{old('direct_phone', $appointment_phone ?? null)}}" placeholder="Enter Phone Number" />
                        <!-- <span class="bx bx-phone"></span> -->
                    </div>
                </div>
