...
<div class="card mb-5">
  ...
  <div class="card-header">
    <a href="{{route('admin.services.create')}}" class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2 "><i
          ...
          <tr>
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    @if (get_user_permission('services', 'u'))
                      <a class="dropdown-item" href="{{ route('admin.services.edit', ['id' => encrypt($role->id)]) }}">
                        <i class="flaticon-pencil-1"></i> Edit
                      </a>
                      @endif

                      @if (get_user_permission('services', 'd'))
                      <a class="dropdown-item" data-role="unlink"
                        data-message="Do you want to remove the service?  This may be linked with other sections"
                        href="{{ route('admin.services.delete', ['id' => encrypt($role->id)]) }}">
