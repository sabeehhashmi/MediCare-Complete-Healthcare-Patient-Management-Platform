...
<div class="card mb-5">
    ...
    <div class="card-header"><a href="{{route('admin.banners.create')}}" class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2 "><i class="mdi mdi-plus me-1"></i> Create Banners</a></div>
    @endif
    <div class="card-body">
                ...
                @foreach($datamain as $key => $datarow) 
                    <tr>
                        ...
                        <td>
                           ...
                           @if($datarow->image)
                           <img src="{{ Storage::disk(config('global.upload_bucket'))->url(config('global.user_image_upload_dir') . $datarow->image) }}" alt="{{$datarow->title}}" style="width: 220px !important; height: auto !important; border-radius: 0 !important;">
                           @else
                           <p>No image found</p>
                           @endif 
                        ...
                        <td>
                            <div class="form-check form-switch form-switch-lg mb-3" dir="ltr">
                                <input type="checkbox" class="form-check-input change_status" data-id="{{ $datarow->id }}"
                                            data-url="{{ url('admin/banners/change_status') }}"
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <a class="dropdown-item" href="{{url('admin/banners/'.$datarow->id.'/edit')}}"><i class="flaticon-pencil-1"></i> Edit</a>
                                    @endif
                                    ...
                                    data-message="Do you want to remove this banners?"
                                    href="{{ url('admin/banners/' . $datarow->id) }}"><i
