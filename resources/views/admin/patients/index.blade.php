...
<div class="card mb-5">
    ...
    <div class="card-header"><a href="{{route('admin.patients.create')}}" class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2 "><i class="mdi mdi-plus me-1"></i> Add Patient </a></div>
    @endif
    <div class="card-body">
            ...
            <div class="row align-items-end mt-3 mx-2">
                 ...
                 <div class="col-lg-3 col-md-4 mb-4">
                    ...
                    <div class="position-relative input-custom-icon">
                        <input type="text" name="patient_id" class="form-control" id="patient_id_search"
                ...
                <div class="col-sm mb-2">
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('admin.patients.export') }}" id="export" class="btn btn-primary"><i
    ...
    <script>
        $(document).ready(function () {
            function updateExportUrl() {
                ...
                let exportUrl = "{{ route('admin.patients.export') }}" + '?' + query;
