...
<div class="card mb-5">
    ...
    <div class="card-header"><a href="{{route('admin.patients.createMember', $patient_id)}}" class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2 "><i class="mdi mdi-plus me-1"></i> Add Member </a></div>
    @endif
    <div class="card-body">
                    ...
                    <tr>
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    ...
                                    @if(get_user_permission('patients','u'))
                                    <a class="dropdown-item" href="{{route('admin.patients.editMember', ['patient_id' => $row->user_id, 'id' => encrypt($row->id)])}}"><i class="flaticon-pencil-1"></i> Edit</a>
                                    @endif
                                    ...
                                    @if (get_user_permission('patients', 'd'))
                                        <a class="dropdown-item" data-role="unlink"
                                            ...
                                            href="{{ route('admin.patients.deleteMember', ['id' => encrypt($row->id)]) }}">
            ...
            <div class="mt-4">
                ...
                <div class="col-sm-12 col-md-12 pull-right">
                    <div class="dataTables_paginate paging_simple_numbers" id="example2_paginate">
                        {!! $records->appends(request()->input())->links('admin.template.pagination') !!}
                    </div>
                </div>
            </div>
