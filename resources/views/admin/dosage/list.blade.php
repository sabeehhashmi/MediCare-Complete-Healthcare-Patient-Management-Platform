...
<div class="card mb-5">
  ...
  <div class="card-header">
    <a href="{{route('admin.dosage.create')}}" class="btn btn-primary waves-effect waves-light mb-2 me-2 "><i
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    @if (get_user_permission('special_intrests', 'u'))
                      <a class="dropdown-item" href="{{ route('admin.dosage.edit', ['id' => encrypt($role->id)]) }}">
                      ...
                      <a class="dropdown-item" data-role="unlink"
                        ...
                        href="{{ route('admin.dosage.delete', ['id' => encrypt($role->id)]) }}">
