...
<div class="card mb-5">
    <!--<div class="card p-4">-->
        <form method="post" id="admin-form" action="{{ route('admin.countries.update',$datamain->id) }}" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" data-jqv-maxlength="100" name="prefix" value="{{old('prefix',$datamain->prefix)}}" required
                                data-parsley-required-message="Enter Prefix">
                            </div>
                        </div>
                        <div class="col-lg-6 mb-4">
                            <div class="form-group">
                                <label>Dial Code<span style="color:red;">*<span></span></span></label>
                                <input type="text" class="form-control" data-jqv-maxlength="100" name="dial_code" value="{{old('dial_code',$datamain->dial_code)}}" required
                                data-parsley-required-message="Enter Dial Code">
                            </div>
                        </div>
