...
<div class="card mb-5">
    ...
    <div class="card-header"><a href="{{url('admin/countries/create')}}" class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2 "><i class="mdi mdi-plus me-1"></i> Create Country</a></div>
    @endif
    <div class="card-body">
                    ...
                    <tr>
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <a class="dropdown-item" href="{{url('admin/countries/'.$datarow->id.'/edit')}}"><i class="flaticon-pencil-1"></i> Edit</a>
                                    @endif
                                    ...
                                    href="{{ url('admin/countries/' . $datarow->id) }}"><i
