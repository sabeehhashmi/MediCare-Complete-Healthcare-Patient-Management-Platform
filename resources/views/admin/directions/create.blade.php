...
@section('content')
<div class="card mb-5">
    <form id="admin_form" method="post" action="{{route('admin.directions.submit')}}" enctype="multipart/form-data" class="custom-form">
        <div class="card-body">
            <div class="row">
                    @csrf()
                    ...
                    <div class="col-lg-6 mb-4">
                        <label class="form-label" direction="rtl" for="bs-validation-name">Title (ar)<span class="text-danger">*</span> </label>
                        <input
