...
@section("content")
    ...
    <div class="card mb-5">
        @if(get_user_permission('clinics','c'))
            <div class="card-header"><a href="{{route('admin.clinics.create')}}"
                                        class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2 "><i
                        class="mdi mdi-plus me-1"></i> Create Clinic</a></div>
        @endif
        <div class="card-body">
                ...
                <div class="row align-items-end mt-3 mx-2">
                    ...
                    <div class="col-sm mb-2">
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('admin.clinics.export') }}" id="export" class="btn btn-primary"><i
