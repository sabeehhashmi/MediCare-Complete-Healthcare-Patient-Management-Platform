...
@section('content')
<div class="card mb-5">
    <form id="admin_form" method="post" action="{{route('admin.clinics.saveInsurance')}}" enctype="multipart/form-data" class="custom-form">
        <div class="card-body">
            <div class="row insu-form-row">
                    ...
                    <div class="col-lg-6 mb-4">
                        ...
                        <select name="sub_insurance_id[]" multiple id="sub_insurance_id" class="form-control jqv-inuput" data-jqv-required="true" role="select2" data-placeholder="Select Insurance">
                            <option></option>
