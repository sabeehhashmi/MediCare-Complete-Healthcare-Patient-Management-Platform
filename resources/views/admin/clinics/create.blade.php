...
<div class="card mb-5">
    <div class="p-4 pt-5">
        <form id="admin_form" method="post" action="{{route('admin.clinics.save')}}" class="registerform" autocomplete="off">
            @csrf
            ...
            <div class="row">
                <div class="col-lg-12 mb-4">
                    ...
                    <div class="position-relative input-custom-icon">
                        <input type="text" class="form-control jqv-input" data-jqv-required="true" id="name_en" name="name_en" value="{{old('name_en', $hospital->name_en ?? null)}}" placeholder="Clinic Name" />
                ...
                <div class="col-lg-6 mb-4">
                    <label class="form-label" for="username"> City / Province </label><a href="#" title="Add more  City / Province" data-bs-toggle="modal" data-bs-target="#newemiratemodel" title="Click to Add More Emirates" class="float-end me-2">Add More</a>
                    <div class="position-relative select-custom-icon">
                    ...
                    <div class="position-relative select-custom-icon">
                        <select name="area_id" id="area_id" class="select2-single jqv-input" data-jqv-required="true" role="select2" data-placeholder="Select Area">
                            @foreach($area_list as $area)
                                <option {{$area->id == ($hospital->area_id ?? null) ? 'selected':''}} value="{{$area->id}}">{{$area->name_en}}</option>
                            @endforeach
                        </select>
                        <i class="bx bx-navigation"></i>
                    </div>
                ...
                <div class="col-lg-6 mb-3">
                    ...
                    <div class="position-relative input-custom-icon">
                        <input type="text" class="form-control jqv-input" data-jqv-required="true" name="address" value="{{old('address', $hospital->address??null)}}" placeholder="Enter Address Of Organization" />
                        <span class="bx bx-building"></span>
                ...
                <div class="col-lg-6 mb-3">
                    <label class="form-label" for="username">Is Contract Signed</label>
                    <div class="position-relative select-custom-icon">
                        <select name="is_contract_signed" class="form-control">
                            <option @if($is_contract_signed==1) selected @endif value="1">Yes</option>
                            <option @if($is_contract_signed==0) selected @endif value="0">No</option>
                ...
                <div class="col-12 mb-3">
                    ...
                    <div class="position-relative input-custom-icon">
                        <input type="text"  data-jqv-required="true" class="form-control autocomplete jqv-input" placeholder="673C+W8V - Dubai - United Arab Emirates" id="txt_location"  name="location" value="{{$hospital->location[0]->location ?? null}}"/>
                ...
                <div class="col-lg-6 mb-4">
                    ...
                    <div class="position-relative">
                        <input type="text" class="form-control jqv-input" id="phone"  name="phone" value="{{$hospital->user->phone ?? null}}" placeholder="Enter Phone Number" />
                ...
                <div class="col-lg-6 mb-4">
                    ...
                    <div class="position-relative input-custom-icon">
                        <input type="email" class="form-control jqv-input" data-jqv-required="true" id="email" name="email" value="{{old('email', $hospital->user->email ?? null)}}" placeholder="Enter Address" />
                ...
                <div class="col-lg-6 mb-4">
                    ...
                    <div class="position-relative auth-pass-inputgroup input-custom-icon">
                        ...
                        @if($id)
                        <input type="password"  class="form-control jqv-input"  id="password-input" name="password" placeholder="Enter password" autocomplete="new-password">
                        @else
                        <input type="password"  class="form-control jqv-input" data-jqv-required="true"  id="password-input" name="password" placeholder="Enter password" autocomplete="new-password">
                        @endif
                ...
                <div class="col-lg-6 mb-4">
                    ...
                    <div class="position-relative input-custom-icon">
                        <input type="text" class="form-control jqv-input" data-jqv-required="false" id="website" value="{{old('website', $hospital->website ?? null)}}" name="website" placeholder="Enter Website" />
                ...
                {{-- <div class="col-lg-6 mb-4">
                    ...
                    <div class="position-relative">
                        ...
                        <input type="text" class="form-control" id="phone1" name="direct_phone" value="{{old('direct_phone', $hospital->appointment_phone ?? null)}}" placeholder="Enter Direct Call for Appointment Number" />
                        <!-- <span class="bx bx-phone"></span> -->
                    </div>
                </div> --}}
                <div class="col-lg-6 mb-4">
                    <div class="custom-upload">
                        ...
                        @if ($hospital->user->user_image ?? null)
                        <a id="previewLink" href="{{$hospital->user->user_img_url}}" target="_blank">View</a>
                        @endif
                    </div>
                </div>
                ...
                <div class="col-12 mb-4">
                    <div class="custom-textarea">
                        ...
                        <textarea class="form-control" id="ckeditor-classic" name="profile_bio" row="5">{{old('profile_description', $hospital->profile_description ?? null)}}</textarea>
                    </div>
                </div>
                ...
                <div class="col-12 mb-4">
                    ...
                    <div id="image_preview" class="row">
                        ...
                        <div class='old-image img-div col-lg-4 col-md-6 mb-3 mt-2' id='existing-img-div-{{$hospital_image->image_url}}'><img src='{{$hospital_image->image_url}}' class='img-fluid w-100' title='Existing Image {{$hospital_image->image_url}}'>
                            <div class='middle'><button type="button" id='delete-image' value='{{$hospital_image->id}}' class='btn btn-danger btn-icon' role='existing_image'><i class='fa fa-trash'></i></button>
                            </div></div>
                        @endforeach
                    </div>
                </div>
                ...
                success: function (res) {
                    ...
                    if ( res['status'] == 0 ) {
                        ...
                        if ( typeof res['errors'] !== 'undefined' ) {
                            ...
                            var m = res['message']||'Unable to save Clinic. Please try again later.';
...
<script>
    $(document).ready(function() {
        ...
        //             $('#image_preview').append("<div class='img-div col-lg-4 col-md-6 mb-3 mt-2' id='existing-img-div" + existingImages[i].image_url + "'><img src='" + existingImages[i].image_url + "' class='img-fluid w-100' title='Existing Image " + (i + 1) + "'><div class='middle'><button id='delete-image' value='existing-img-div" + i + "' class='btn btn-danger btn-icon' role='existing_image'><i class='fa fa-trash'></i></button></div></div>");
        //         }
        //     }
        // }
...
var existingDialCode = "{{($hospital)? $hospital->user->dial_code :''}}";
if(existingDialCode){
...
updateDialCode();
        ...
        input1.addEventListener("input", function (e) {
            ...
            let value1 = e.target.value.replace(/[^0-9]/g, '');

                // Prevent starting with 0
                if (value1.startsWith('0')) {
        ...
        setTimeout(function() {
        let phoneValue1 = input1.value;
        if (phoneValue1.startsWith('0')) {
            input1.value = phoneValue1.substring(1);  // Remove the leading zero
        }
    }, 1000);
        </script>
...
<script>
    ...
    var currentLat = <?php echo $hospital->location[0]->latitude ?? 25.204819 ?>;
    var currentLong = <?php echo $hospital->location[0]->longitude ?? 55.270931 ?>;
    ...
    places2.forEach(function(place) {
        ...
        if (!isInsideUAE(lat, lng)) {
    
    alert("Location must be inside UAE.");
    
    var defaultPosition = new google.maps.LatLng(currentLat, currentLong);
    
    usermarker.setPosition(defaultPosition);
    map2.panTo(defaultPosition);
