...
<div class="card mb-5">
  ...
  <div class="card-header">
    <a href="{{route('admin.clinics.createInsurance', $hospital_id)}}" class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2 "><i
        class="mdi mdi-plus me-1"></i> Create Clinic Insurance</a>
  </div>
  @endif
  <div class="card-body">
    <div class="table-responsive">
      <table class="table table-condensed table-striped" id="example21">
        <thead>
          <tr>
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                      ...
                      <a class="dropdown-item" data-role="unlink"
                        ...
                        href="{{ route('admin.clinics.deleteInsurance', ['id' => encrypt($row->id)]) }}">
