...
<div class="card mb-5">
    <div class="p-4 pt-5">
        <form id="admin_form" method="post"  action="{{ url('/admin/user_insctruction/create') }}" autocomplete="off">
            @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-4 form-group">
                            ...
                            <select name="type" class="form-control">
                                <option   value="1">Managing An Account</option>
                                <option  value="2">Booking An Appointment</option>
                                <option  value="3">Managing An Appointment</option>
                                <option  value="4"> Adding Family or Friends</option>
