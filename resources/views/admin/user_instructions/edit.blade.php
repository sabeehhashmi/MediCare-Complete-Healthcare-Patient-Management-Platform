...
<div class="card mb-5">
    <div class="p-4 pt-5">
        <form action="{{ url('/admin/user_insctruction/update') }}" id="admin_form" enctype="multipart/form-data">
            @csrf
                ...
                <div class="row  d-flex justify-content-between align-items-center">
                    ...
                    <div class="col-md-6 mb-4 form-group">
                        ...
                        <select name="type" class="form-control">
                            <option  <?= $faq->type == 1 ? 'selected' : '' ?> value="1">Managing An Account</option>
                            <option <?= $faq->type == 2 ? 'selected' : '' ?> value="2">Booking An Appointment</option>
                            <option <?= $faq->type == 3 ? 'selected' : '' ?> value="3">Managing An Appointment</option>
                            <option <?= $faq->type == 4 ? 'selected' : '' ?> value="4"> Adding Family or Friends</option>
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if ( res['status'] == 0 ) {
                        ...
                        setTimeout(function(){
                            window.location.href = "{{url('/admin/user_insctruction')}}";
                        },2500);
