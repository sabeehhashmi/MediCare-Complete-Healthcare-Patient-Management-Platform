...
<div class="card mb-5">
    ...
    <div class="card-header"><a href="{{url('admin/user_insctruction/create')}}" class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2"> Create User Instructions for Patients</a></div>
    @endif
    <div class="card-body">
               ...
               <tr>
                   ...
                   <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <a class="dropdown-item" href="{{url('admin/user_insctruction/edit/'.$item->id)}}"><i class="flaticon-pencil-1"></i> Edit</a>
                                    @endif
                                    ...
                                    data-message="Do you want to remove this user insctruction?"
                                    href="{{ url('admin/user_insctruction/delete/' . $item->id) }}"><i
