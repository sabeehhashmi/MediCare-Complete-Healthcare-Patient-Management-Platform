...
<div class="card mb-5">
    <div class="p-4 pt-5">
        <form id="admin_form" method="post"  action="{{ url('/admin/faq/create') }}" autocomplete="off">
            @csrf
            <input type="hidden" value="{{$cms_page->id??''}}" name="id">
                    <div class="row">
                        ...
                        <div class="col-12 mb-4 form-group">
                            ...
                            <textarea name="answer" rows="5" class="form-control jqv-input" data-jqv-required="true" required
