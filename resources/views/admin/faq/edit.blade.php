...
<div class="card mb-5">
    <div class="p-4 pt-5">
        <form action="{{ url('/admin/faq/update') }}" id="admin_form" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="id" value="{{$faq->id}}">
                <div class="row  d-flex justify-content-between align-items-center">
                    ...
                    <div class="col-md-12 mb-4 form-group">
                        ...
                        <textarea name="answer" rows="5" class="form-control jqv-input" data-jqv-required="true" >{{$faq->description}}</textarea>
                    </div>
