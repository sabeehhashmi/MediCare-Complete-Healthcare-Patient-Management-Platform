...
<div class="card mb-5">
  ...
  <div class="card-header">
    <a href="{{route('admin.refferal_doctors.create')}}?referral_id={{ isset($_GET['referral_id'])?$_GET['referral_id']:'' }}" class="btn btn-primary waves-effect waves-light mb-2 me-2 "><i
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    @if (get_user_permission('special_intrests', 'u'))
                      <a class="dropdown-item" href="{{ route('admin.refferal_doctors.edit', ['id' => encrypt($role->id)]) }}?referral_id={{ isset($_GET['referral_id'])?$_GET['referral_id']:''}}">
                      ...
                      <a class="dropdown-item" data-role="unlink"
                        ...
                        href="{{ route('admin.refferal_doctors.delete', ['id' => encrypt($role->id)]) }}">
