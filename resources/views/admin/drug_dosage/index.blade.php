            ...
            <div class="card-header">
                <div class="col-lg-12">
                    <div class="d-flex gap-2 justify-content-end">
                       ...
                       <button type="button"  class="btn btn-primary m-0 " data-bs-toggle="modal" data-bs-target="#addModalData">Add New Drug Dosage</button>
                    </div>
                </div>
            </div>
            <div class="card-body">
  ...
  <!-- Add New Medicine modal -->
        ...
        <div class="modal fade" id="addModalData" tabindex="-1" aria-labelledby="appointmentModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
                <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="appointmentModalLabel">Add New Drug Dosage</h1>
