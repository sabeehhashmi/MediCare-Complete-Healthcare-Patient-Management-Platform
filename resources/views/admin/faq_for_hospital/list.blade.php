...
<div class="card mb-5">
    ...
    <div class="card-header"><a href="{{url('admin/faq-for-hospital/create')}}" class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2"> Create FAQ For Clinic/Hospital</a></div>
    @endif
    <div class="card-body">
               ...
               <tr>
                   ...
                   <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <a class="dropdown-item" href="{{url('admin/faq-for-hospital/edit/'.$item->id)}}"><i class="flaticon-pencil-1"></i> Edit</a>
                                    @endif
                                    ...
                                    href="{{ url('admin/faq-for-hospital/delete/' . $item->id) }}"><i
