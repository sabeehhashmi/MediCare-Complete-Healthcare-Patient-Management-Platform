...
<div class="card mb-5">
    <!--<div class="card p-4">-->
        <form method="post" id="admin-form" action="{{ route('admin.videos.update',$video->id) }}" enctype="multipart/form-data"
            ...
            <div class="">
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6 col-xs-12 mb-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" data-jqv-maxlength="100" name="title" value="{{old('title',$video->title)}}" required
                    ...
                    <div class="custom-textarea">
                        ...
                        <textarea class="form-control" id="ckeditor-classic" name="description" row="5">{{ $video->description }}</textarea>
                    </div>
                </div>

                       <div class="col-sm-12 col-xs-12 mb-4">
                        <div class="form-group">
                            <label>Add Video<span style="color:red;">*<span></span></span></label>  

                            @if($video->file)
                            <div class="pb-3 pt-3">
                               <a href="{{ $video->file }}">Video</a>
                           
                            </div>
                            @endif


                            <input class="form-control jqv-input" id="imageUpload" type="file" name="image"  />
                        ...
                        <div class="col-sm-4 col-xs-12 mb-4">
                            <div class="form-group">
                                ...
                                <select name="status" class="form-control status-selection">
                                    <option @if(!empty($video)) {{$video->status==1 ? "selected" : null}} @endif value="1">Active</option>
                                    <option @if(!empty($video)) {{$video->status==0 ? "selected" : null}} @endif value="0">Inactive</option>
                                </select>
                            </div>
                        </div> 
                    </div>
