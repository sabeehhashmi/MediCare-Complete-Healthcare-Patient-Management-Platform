            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="custom-textarea">
                        ...
                        <textarea class="form-control" id="ckeditor-classic" name="description" row="5"></textarea>
                    </div>
                </div>
                    ...
                    <div class="col-sm-12 col-xs-12 mb-4">
                        <div class="form-group">
                            ...
                            <input class="form-control jqv-input" id="imageUpload" type="file" name="image"  required
