...
<div class="card mb-5">
  ...
  <div class="card-header">
    <a href="{{route('admin.departments.create')}}" class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2 "><i
        class="mdi mdi-plus me-1"></i> Create Department</a>
  </div>
  @endif
  <div class="card-body">
            ...
            <td>
                <div class="form-check form-switch form-switch-lg mb-3" dir="ltr">
                    <input type="checkbox" class="form-check-input change_status" data-id="{{ $role->id }}"
                                data-url="{{ url('admin/departments/change_status') }}"
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    @if (get_user_permission('departments', 'u'))
                      <a class="dropdown-item" href="{{ route('admin.departments.edit', ['id' => encrypt($role->id)]) }}">
                      ...
                      <a class="dropdown-item" data-role="unlink"
                        data-message="Do you want to remove the departments?  This may be linked with other sections"
                        href="{{ route('admin.departments.delete', ['id' => encrypt($role->id)]) }}">
