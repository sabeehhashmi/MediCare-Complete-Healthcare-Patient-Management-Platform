...
<div class="card mb-5">
    <div class="p-4 pt-5">
        <form id="admin_form" method="post" action="{{route('admin.appointments.save')}}" class="registerform" autocomplete="off">
            @csrf
            ...
            <div class="row">
                <div class="col-12 mb-3">
                    ...
                    <div class="position-relative">
                        <select name="bookTypeSelct" id="bookTypeSelct" class="select2-single" data-placeholder="Select type">
                            <option></option>
