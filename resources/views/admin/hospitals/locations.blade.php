...
<div class="card mb-5">
  ...
  <div class="card-header">
    <a href="{{route('admin.hospitals.createLocation', $hospital_id)}}" class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2 "><i
          ...
          <tr>
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                      ...
                      <a class="dropdown-item" href="{{ route('admin.hospitals.editLocation', ['hospital_id' => $hospital_id, 'id' => encrypt($row->id)]) }}">
                      ...
                      <a class="dropdown-item" data-role="unlink"
                        ...
                        href="{{ route('admin.hospitals.deleteLocation', ['id' => encrypt($row->id)]) }}">
