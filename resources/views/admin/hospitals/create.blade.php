...
<!-- <div class="col-lg-12">
    ...
    <div class="p-4 pt-5">
        <form id="admin_form" method="post" action="{{route('admin.hospitals.save')}}" class="registerform" autocomplete="off">
            @csrf
            ...
            <div class="row">
                <div class="col-lg-12 mb-4">
                    ...
                    <div class="position-relative input-custom-icon">
                        <input type="text" class="form-control jqv-input" data-jqv-required="true" id="name_en" name="name_en" value="{{old('name_en', $hospital->name_en ?? null)}}" placeholder="Hospital Name" />
                ...
                <div class="col-lg-6 mb-4">
                    <label class="form-label" for="username"> City / Province </label><a href="#" class="float-end me-2" title="Add more City / Province" data-bs-toggle="modal" data-bs-target="#newemiratemodel" title="Click to Add More Emirates">Add More</a>
                    <div class="position-relative select-custom-icon">
                ...
                <div class="col-12 mb-3">
                    ...
                    <div class="position-relative input-custom-icon">
                        <div id="location-error" class="error-message" style="color: red; display: none;">
                            Location is required.
                        </div>
                        <input type="text" class="form-control autocomplete" placeholder="673C+W8V - Dubai - United Arab Emirates" id="txt_location"  name="location" value="{{$hospital->location[0]->location ?? null}}"/>
                ...
                <div class="col-lg-6 mb-4">
                    ...
                    <div class="position-relative">
                        ...
                        <input type="text" class="form-control jqv-input" id="phone" name="phone"  value="{{old('phone', $hospital->user->phone ?? null)}}" placeholder="Enter Phone Number" />
                ...
                {{-- <div class="col-lg-6 mb-4">
                    ...
                    <div class="position-relative">
                        ...
                        <input type="tel" class="form-control" id="phone1" name="direct_phone"  value="{{old('direct_phone', $appointment_phone ?? null)}}" placeholder="Enter Direct Call for Appointment Number" />
                        <!-- <span class="bx bx-phone"></span> -->
                        <div id="direct-call-error" class="error-message" style="color: red; display: none;">
                            Direct Call for Appointment Number is required.
                        </div>
                    </div>
                </div> --}}
                <div class="col-lg-6 mb-4">
                ...
                <div class="col-12 mb-4">
                    ...
                    <div id="image_preview" class="row">
                        @foreach($hospital->images ?? [] as $hsk => $hospital_image)
                            <div class='old-image img-div col-lg-4 col-md-6 mb-3 mt-2' id='existing-img-div-{{$hospital_image->image_url}}'><img src='{{$hospital_image->image_url}}' class='img-fluid w-100' title='Existing Image {{$hospital_image->image_url}}'><div class='middle'><button type="button" id='delete-image' value='{{$hospital_image->id}}' class='btn btn-danger btn-icon' role='existing_image'><i class='fa fa-trash'></i></button></div></div>
                        @endforeach
                    </div>
                </div>
...
$(document).ready(function() {
    ...
    $('body').on('submit', '#admin_form', function(e) {
        ...
        var locationField = $("#txt_location");
                ...
                success: function (res) {
                    ...
                    if ( res['status'] == 0 ) {
                        ...
                        if ( typeof res['errors'] !== 'undefined' ) {
                            ...
                            var m = res['message']||'Unable to save Hospital. Please try again later.';
    ...
    function loadEmirates(countryId, selectedEmirateId = ''){
        $('#emirate_id').html('<option disabled >Loading..</option>');
        if (countryId) {
            $.ajax({
                type: "GET",
                ...
                success: function (res) {
                    if (res) {
                        // $('#emirate_id').empty();
                        $('#emirate_id').html('<option value="">Select Emirate</option>');
...
$("body").on('click', '.delete-uploaded-image', function(){
   ...
   function FileListItem(file) {
       ...
       //     initialCountry: '{{INIT_PHONE_C_CODE}}',
        ...
        <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key={{env('GOOGLE_MAP_KEY')}}&v=weekly&libraries=places">
</script>
<script>
