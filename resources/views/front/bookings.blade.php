    ...
    <div class="row align-items-end mt-3 mb-3">
        ...
        <div class="col-sm mb-2">
            <div class="d-flex gap-2">
               ...
               <a href="{{ route('front.export', request()->query()) }}" 
   class="btn btn-primary">
   <i class="mdi mdi-file-excel"></i> Export Excel
</a>  
 <a href="{{ route('front.export.pdf', request()->query()) }}" 
   class="btn btn-primary">
   <i class="mdi mdi-file-excel"></i> Export Pdf
</a>
            </div>
        </div>
                        ...
                        <div class="booking-tabs mb-30">
                            <button class="tab-btn active" data-target="listView">
                                <i class="bx bx-list-ul"></i> List
                            </button>

                            <button class="tab-btn" data-target="calendarViewfull">
                                                        ...
                                                        <div class="accordion-item wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                                                            <h5 class="accordion-header" id="flush-heading{{ $key }}">
                                                                <button class="accordion-button collapsed" type="button"
                                                                    ...
                                                                    aria-expanded="false" aria-controls="flush-collapse{{ $key }}">{{ $appointment->booking_id }} - {{ \Illuminate\Support\Str::start($appointment->doctor_name, 'Dr. ') }}
                                                            ...
                                                            <div id="flush-collapse{{ $key }}" class="accordion-collapse collapse"
                                                                ...
                                                                <div class="accordion-body">
                                                                    ...
                                                                    <div class="d-flex justify-content-between">
                                                                        <span>Allow Document Access:  <div class="form-check form-switch form-switch-lg mb-3" dir="ltr">
                        <input type="checkbox" class="form-check-input change_status" data-id="{{$appointment->id  }}"
                                    data-url="{{url('front/appointments/change_status')  }}"
