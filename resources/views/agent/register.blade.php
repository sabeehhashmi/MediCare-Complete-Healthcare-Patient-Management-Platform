...
<head>
        ...
        <meta charset="utf-8" />
        <title>Agent Register | Mednero</title>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 mb-3">
                                                ...
                                                <div class="position-relative input-custom-icon">
                                                    <input type="text" class="form-control" required name="name_en" placeholder="Hospital Name">
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                ...
                                                <div class="position-relative auth-pass-inputgroup input-custom-icon">
                                                    ...
                                                    <input type="password" required class="form-control" id="password-input" name="password" placeholder="Enter Password" autocomplete="new-password">
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                ...
                                                <input type="hidden" id="direct_dial_code" name="direct_dial_code" value="{{old('direct_dial_code', $hospital->appointment_dial_code ?? null)}}" >
                                                    <input type="number" class="form-control" id="phone1" name="direct_phone" placeholder="Enter Phone Number">
                                          ...
                                          {{--  <div class="col-12 mb-3">
                                            ...
                                            <div class="col-12 mb-3">
                                                <div class="form-check py-1 d-flex align-items-center">
                                                    ...
                                                    <label class="form-check-label" for="auth-remember-check" required> by proceeding Agree <a href="{{url('agent/terms-conditions')}}" data-fancybox data-type="iframe">Terms and conditions</a></label>
                                                </div>
                                            </div>
