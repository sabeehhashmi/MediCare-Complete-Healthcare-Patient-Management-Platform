...
<div class="card-header card-header d-flex justify-content-between">
            <a href="{{route('agent.hospitals.createInsurance', $hospital_id)}}" class="btn btn-primary w-auto ml-auto">Create Hospital Insurance</a>
        </div>
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                      ...
                      <a class="dropdown-item" data-role="unlink"
                        ...
                        href="{{ route('agent.hospitals.deleteInsurance', ['id' => encrypt($row->id)]) }}">
