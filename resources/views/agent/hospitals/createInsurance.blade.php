...
<div class="card mb-5">
    <form id="admin_form" method="post" action="{{route('agent.hospitals.saveInsurance')}}" enctype="multipart/form-data" class="custom-form">
        <div class="card-body">
            <div class="row insu-form-row">
                    ...
                    <div class="col-lg-6 mb-4">
                        ...
                        <select name="sub_insurance_id[]" multiple id="sub_insurance_id" class="form-control jqv-inuput" role="select2" data-placeholder="Select Sub Insurance">
...
$(document).ready(function() {
    ...
    function loadSubInsurance(parentId, selectedId = ''){
        if (parentId) {
            $.ajax({
                type: "GET",
                url: "{{ url('agent/get-subInsurence') }}/" + parentId,
                success: function (res) {
                    if (res) {
                        $('#sub_insurance_id').html("");
