...
<div class="card mb-5">
    <div class="p-4 pt-5">
        <form id="admin_form" method="post" action="{{route('agent.hospitals.save')}}" class="registerform" autocomplete="off">
            @csrf
            ...
            <div class="row">
                ...
                {{-- <div class="col-lg-6 mb-4">
                    ...
                    <div class="position-relative">
                        <input type="text" class="form-control" id="phone1" name="direct_phone" value="{{old('direct_phone', $appointment_phone ?? null)}}" placeholder="Enter Direct Call for Appointment Number" />
