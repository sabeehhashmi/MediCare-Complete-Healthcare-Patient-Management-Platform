...
<head>
        ...
        <meta charset="utf-8" />
        <title>Agent Login | {{config('global.site_name')}}</title>
                        ...
                        <div class="card overflow-hidden">
                            <div class="card-body p-4">
                                ...
                                <div class="text-center mt-2">
                                    <h5>Welcome Back !</h5>
                                    <p class="text-black">Sign in to continue to Agent Panel.</p>
                                </div>
                                <div class="p-2 mt-4">
                                    <form class="form-login" action="{{ url('agent/check_login') }}" method="POST">
                                       @csrf
                                        <div class="mb-3">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup input-custom-icon">
                                                <span class="bx bx-lock-alt"></span>
                                                <input type="password" class="form-control" id="password-input" placeholder="Enter New password" autocomplete="new-password">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup input-custom-icon">
                                                <span class="bx bx-lock-alt"></span>
                                                <input type="password" class="form-control" id="password-input" placeholder="Enter Confirm password" autocomplete="new-password">
                                                <button type="button" class="btn btn-link position-absolute h-100 end-0 top-0" id="">
                                                    <i class="mdi mdi-eye-outline font-size-18 text-muted"></i>
                                                </button>
                                            </div>
...
$("#loginOtpForm").submit(function(e) {
    ...
    $.ajax({
        type: 'POST',
        url: "{{ route('agent.verify.login.otp') }}",
        data: {
            _token: $('input[name=_token]').val(),
