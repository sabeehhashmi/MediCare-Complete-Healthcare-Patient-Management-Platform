...
<div class="position-relative">
    <div class="card">
        <div class="card-body">
        <form id="instantappForm" method="post" action="{{route('agent.instantappointment_save')}}" class="registerform" autocomplete="off">
            @csrf
...
<script>
    $(document).ready(function() {
        $('body').on('click', '.delete-instant', function(e) {
            ...
            var id = $(this).data('id');
            var href = '{{ url("agent/instantappointment_delete") }}/' + id;
