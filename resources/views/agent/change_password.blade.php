...
<div class="position-relative">
    ...
    @include('agent.layouts.left_nav_profile')
        ...
        <div class="w-100 user-chat mt-4 mt-sm-0 ms-lg-3">
            <div class="card">
                <div class="p-4 pt-5">
                    <form  id="hospital-form-changepwd" action="{{url('agent/change_password')}}" enctype="multipart/form-data"  class="custom-form">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="password" name="cur_pswd" class="form-control" placeholder="Enter " id="formrow-firstname-input" autocomplete="new-password" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="password" name="new_pswd" class="form-control" placeholder="Enter" id="formrow-email-input" autocomplete="new-password"/>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label class="form-label" for="formrow-password-input">Confirm New Password</label>
                                    <input type="password" name="confirm" class="form-control" placeholder="Enter" id="formrow-password-input" autocomplete="new-password"/>
                                </div>
                            </div>
                        </div>
