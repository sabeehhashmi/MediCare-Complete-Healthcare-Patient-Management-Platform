...
<div class="position-relative mb-5">
    ...
    @include('agent.layouts.left_nav_profile')
        ...
        <div class="w-100 user-chat mt-4 mt-sm-0 ms-lg-3">
            <div class="card">
                <div class="p-4 pt-5">
                <form id="admin_form" method="post" action="{{route('agent.save_profile')}}" class="registerform" autocomplete="off">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-4">
                    ...
                    <div class="position-relative input-custom-icon">
                        <input type="email" class="form-control jqv-input" {{($email ?? null) ? 'readonly' : 'false'}} data-jqv-required="true" id="email" @if ($email) value={{$email}} @endif name="email" placeholder="Enter Address" />
                ...
                <div class="col-lg-6 mb-4">
                    ...
                    <div class="position-relative">
                        <input type="text" class="form-control" @if ($phone) value={{$phone}} @endif id="phone" name="phone" placeholder="Enter Phone Number" />
                ...
                <div class="col-lg-6 mb-4">
                    <label class="form-label" for="username">Call Center</label>
                    <div class="position-relative select-custom-icon">
                        <select name="callcenter_id" id="callcenter_id" class="select2-single jqv-input" data-jqv-required="true" role="select2" data-placeholder="Select Call Center">
                            @foreach($callcenter_list as $callcenter)
