...
<div class="position-relative mb-5">
    <div class="d-lg-flex">
        <div class="chat-leftsidebar card">
            <div class="card-body" style="flex: 0;">
                <div class="text-center bg-light rounded px-4 py-3">
                    ...
                    <h5 class="font-size-16 mb-1 mt-3"><a href="#" class="text-reset">{{$name}} Agent </a></h5>
                    <p class="text-muted mb-0">{{$hospital->address}}</p>
                </div>
            </div>

            <div class="mail-list">
                <a href="{{ url('agent/get_profile') }}" class=" ">
                ...
                <a href="{{ url('agent/edit_profile') }}" class="border-bottom">
                    <div class="d-flex align-items-center">
                ...
                <a href="{{ url('agent/ourinsurance') }}" class="border-bottom active bg-primary-subtle">
                    <div class="d-flex align-items-center">
                ...
                <a href="{{ url('agent/change_password') }}" class="border-bottom">
                    <div class="d-flex align-items-center">
        ...
        <div class="w-100 user-chat mt-4 mt-sm-0 ms-lg-3">
            <div class="card">
                <div class="p-4 pt-4">
                <form method="post" id="insuranceform" class="insuranceform" action="{{ url('agent/saveinsurance') }}" enctype="multipart/form-data">
                  @csrf
