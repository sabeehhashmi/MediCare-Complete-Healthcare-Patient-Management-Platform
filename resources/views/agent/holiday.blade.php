...
<div class="position-relative">
    <div class="card">
        <div class="card-body">
        <form id="holidayForm" method="post" action="{{route('agent.holiday_save')}}" class="registerform" autocomplete="off">
            @csrf
            ...
            <div class="col-md-12 mb-3">
                ...
                <div class="row">
                    <div class="col-12 text-center d-flex flex-wrap">
                        <button type="submit" class="btn btn-primary me-3">Update Holiday</button>
