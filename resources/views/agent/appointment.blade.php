...
<div class="card">
        ...
        <div class="position-relative">
            <!-- <div class="d-flex gap-2 justify-content-between mb-3">
                <div class="btn-group toggle-btn-g-tabs-cale" role="group" aria-label="Basic checkbox toggle button group">
                    ...
                    <label class="btn btn-outline-primary" for="btncheck4"><img class="icn" src="{{ asset('') }}agent/assets/images/table-view.png" alt="" /></label>

                    <input type="radio" class="btn-check" name="scs" id="btncheck5" autocomplete="off" />
                    <label class="btn btn-outline-primary" for="btncheck5"><img class="icn" src="{{ asset('') }}agent/assets/images/calender-icon.png" alt="" /></label>
                </div>
    ...
    <form action="{{ route('agent.appointments', $param) }}" method="GET" id="search-form">
    @if($doctor)
    ...
    @endif
        ...
        @endif
        @if($hospital)
        <input type="hidden" name="hospital_id" id="hospital_id" value="{{$hospital->id ?? null}}">
        @endif
    <div class="row align-items-end">
        ...
        <div class="col-sm">
            ...
            <div class="d-flex mt-3 mb-3">
                ...
                <a href="{{route('agent.appointments', $param)}}" type="button"  class=" btn btn-info waves-effect waves-light">Refresh</a>
                <a href="{{ route('agent.appointments.export', $param) }}" id="export" class="btn btn-primary"><i class="mdi mdi-file-excel"></i> Export</a>
            </div>
            </div>
        </div>
