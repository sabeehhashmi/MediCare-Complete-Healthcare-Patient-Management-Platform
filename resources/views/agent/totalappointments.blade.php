...
<div class="card">
    <div class="card-body">
        <div class="position-relative">
            ...
            <form action="{{ route('agent.totalappointments') }}" method="GET" id="search-form">
                <div class="row align-items-end">
                    ...
                    <div class="col-sm">
                        ...
                        <div class="d-flex mt-3 mb-3">
                            ...
                            <a href="{{route('agent.totalappointments')}}" type="button"  class=" btn btn-info waves-effect waves-light">Refresh</a>
                                ...
                                <td>
                                    <div class="dropdown mt-4 mt-sm-0">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            href="{{ route('agent.patient_appointment_urgent', ['id' => $appointment->id])  }}">
                                            Make Urgent
                                        </a>
                                    ...
                                    <div class="single-doctor-appointment mb-4">
                                        <div class="d-flex align-items-center gap-2 mb-3">
                                            ...
                                            <div class="flex-grow-1">
                                                <h4 class="font-size-20 mb-2">DR {{($doctord->user)?$doctord->user->name : null}}</h4>
