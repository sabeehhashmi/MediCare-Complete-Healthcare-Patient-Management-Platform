            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-4">
                    ...
                    <div class="position-relative auth-pass-inputgroup input-custom-icon">
                                                ...
                                                <input type="password" class="form-control" id="password-input" name="password" placeholder="Enter password" autocomplete="new-password">
            ...
            success: function(res) {
                ...
                if (res['status'] == 0) {
                        ...
                        toastr["success"](res['message']);
                                ...
                                setTimeout(function(){
                                    window.location.href = "{{ url('agent/doctors') }}";
                                },1500);
