...
<div class="card mb-5">
    ...
    <div class="col-lg-12 mb-5">
            ...
            <a  data-bs-toggle="modal" data-bs-target="#appointment-modal" class="btn btn-primary w-auto ml-auto reset-modal">Make an Appointment</a>
        </div>
    <!-- <a  data-bs-toggle="modal" data-bs-target="#appointment-modal" class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2 "><i class="mdi mdi-plus me-1"></i>Make an Appointment</a></div> -->
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" value="{{$agent_id ?? null}}" id="agent_id" name="agent_id">
                            <div class="col-lg-12 mb-3">
                                ...
                                <div class="position-relative select-custom-icon">
                                    <select name="hospital_id" id="PatientSelct" class="select2-single jqv-input" data-jqv-required="true" data-placeholder="Select Clinic/Hospital">
                                    @if($hospitals)
                            ...
                            <div class="col-lg-12 mb-3">
                                ...
                                <div class="position-relative select-custom-icon">
                                    <select name="department_id" id="PatientSelct" class="select2-single jqv-input" data-jqv-required="true" data-placeholder="Select Department">
                                    @if($departments)
                            ...
                            <div class="col-lg-12 mb-3">
                                ...
                                <div class="position-relative select-custom-icon">
                                    <select name="doctor_id" id="PatientSelct" class="select2-single jqv-input" data-jqv-required="true" data-placeholder="Select Doctor">
                                    @if($doctors)
...
$(document).ready(function () {
   ...
   //  alert(value);
    $('#table_list').DataTable({
        ...
        ajax: {
            'type':'POST',
            'url' : '{{ route("agent.agents.appointmentLoadData") }}',
            'data':{
                '_token': '{{csrf_token()}}',
                'agent_id': value
            }
    ...
    <script>
     ...
     let data = new FormData(form);
      ...
      $.ajax({
        url: "{{ route('admin.agents.patientAppointmentSave') }}",
        type: "POST",
        data : data,
        dataType:"JSON",
        processData : false,
