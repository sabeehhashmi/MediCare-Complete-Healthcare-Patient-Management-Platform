...
<div class="card mb-5">
    ...
    <div class="card-header"><a href="{{route('admin.agents.hospital_create', ($agent_id ?? null))}}" class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2 "><i class="mdi mdi-plus me-1"></i> Create Hospital</a></div>
    @endif
    <div class="card-body">
...
$(document).ready(function () {
    ...
    $('#table_list').DataTable({
        ...
        ajax: {
            'type':'POST',
            'url' : '{{ route("admin.agents.hospital_load") }}',
            'data':{
                '_token': '{{csrf_token()}}',
                'agent_id': value
            }
