...
<div class="card-header card-header d-flex justify-content-between">
    @if($hospital_id)
    <a href="{{route('agent.createDoctor' , ['hospital_id' => $hospital_id])}}" class="btn btn-primary w-auto ml-auto"> Add Doctor</a>
    @elseif($clinic_id)
    <a href="{{route('agent.createDoctor' , ['clinic_id' => $clinic_id])}}" class="btn btn-primary w-auto ml-auto"> Add Doctor</a>
    @else
    <a href="{{route('agent.createDoctor')}}" class="btn btn-primary w-auto ml-auto"> Add Doctor</a>
    @endif
</div>
...
$(document).ready(function () {
    ...
    $('#table_list').DataTable({
        ...
        ajax: {
            type: 'POST',
            url: '{{ route("agent.load-data-doctors") }}',
            data: {
                '_token': '{{csrf_token()}}',
