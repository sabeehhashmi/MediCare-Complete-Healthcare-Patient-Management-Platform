...
<div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <a href="{{route('agent.doctors')}}" class="card bg-white">
            <div class="card-body">
                <div>
                    <div class="d-flex align-items-center">
                        <div class="avatar">
                            <div class="avatar-title rounded bg-primary">
                                <i class="fi fi-rr-stethoscope icon font-size-22 mb-0 text-white" style="top:2px !important"></i>
                            </div>
                        </div>
    ...
    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <a href="{{route('agent.hospitals')}}" class="card bg-white">
            <div class="card-body">
                <div>
                    <div class="d-flex align-items-center">
                        <div class="avatar">
                            <div class="avatar-title rounded bg-warning">
                                <i class="fi fi-rr-hospital icon font-size-22 mb-0 text-black" style="top:2px !important"></i>
                            </div>
                        </div>

                        <div class="flex-grow-1 ms-3">
                            <h6 class="mb-0 font-size-15">Hospitals</h6>
                        </div>
                    </div>
                    <div>
                        <h4 class="mt-2 pt-1 mb-0 h1">
    ...
    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <a href="{{route('agent.totalappointments')}}" class="card bg-white">
            <div class="card-body">
                <div>
                    <div class="d-flex align-items-center">
                        <div class="avatar">
    ...
    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <a href="{{ route('agent.totalappointments', ['booking_status' => BOOKING_STATUS_PENDING ]) }}" class="card bg-white">
            <div class="card-body">
                <div>
                    <div class="d-flex align-items-center">
                        <div class="avatar">
    ...
    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <a href="{{ route('agent.totalappointments', ['booking_status' => BOOKING_STATUS_CONFIRMED ]) }}" class="card bg-white">
            <div class="card-body">
                <div>
                    <div class="d-flex align-items-center">
                        <div class="avatar">
    ...
    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <a href="{{ route('agent.totalappointments', ['booking_status' => BOOKING_STATUS_COMPLETED ]) }}" class="card bg-white">
            <div class="card-body">
                <div>
                    <div class="d-flex align-items-center">
                        <div class="avatar">
    ...
    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <a href="{{ route('agent.totalappointments', ['booking_status' => BOOKING_STATUS_CANCELLED ]) }}" class="card bg-white">
            <div class="card-body">
                <div>
                    <div class="d-flex align-items-center">
                        <div class="avatar">
    ...
    <div class="col-md-6 col-xl-3 mb-4">
        <a href="{{route('agent.totalappointments', ['booking_type' => 'New Consultation'])}}"  class="card">
            <div class="card-body">
    ...
    <div class="col-md-6 col-xl-3 mb-4">
        <a href="{{route('agent.totalappointments', ['booking_type' => 'Follow-up Consultation'])}}"  class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
    ...
    <div class="col-md-6 col-xl-3 mb-4">
        <a href="{{route('agent.totalappointments', ['booking_type' => 'Second Opinion'])}}"  class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
    ...
    <div class="col-md-6 col-xl-3 mb-4">
        <a href="{{route('agent.totalappointments', ['booking_type' => 'Online Consultation'])}}"  class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
    ...
    <div class="col-md-6 col-xl-3 mb-4">
        <a href="{{route('agent.totalappointments', ['booking_type' => 'Emergency Consultation'])}}"  class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                    ...
                    <table class="table table-striped table-bordered align-middle" id="example2">
                        ...
                        @foreach ($appointments as $key => $appointment)
                            <tr>
                                ...
                                <td>
                                    <a href="#!" class="patient-link"><img src="{{ $appointments[0]->user->user_img_url ?? null }}" width="32" height="32" class="me-2" alt="" />{{$appointments[0]->user->first_name ??''}} {{$appointments[0]->user->last_name ??''}}</a>
                                </td>
                                ...
                                <td>
                                    <div class="dropdown mt-4 mt-sm-0">
                                        ...
                                        <div class="dropdown-menu">
                                                    <a class="dropdown-item cancel-link" href="{{route('agent.appointmentdetail',['id'=>$appointment->id])}}">View Appointment</a>
                                                    @if(strtolower($appointment->booking_status) == 'pending')
                        ...
                        @foreach ($appointments as $key => $appointment)
                            <tr>
                                ...
                                <td>{{ $appointment->booking_id }}<br> 
                                    <!--<span class="badge rounded-pill text-bg-success p-1 px-2 font-size-10 fw-normal">New</span>-->
                                    <span class="badge rounded-pill text-bg-primary p-1 px-2 font-size-10 fw-normal">Follow-up</span>
                                    <!--<span class="badge rounded-pill text-bg-warning p-1 px-2 font-size-10 fw-normal">Second Opinion</span>-->
                                    <!--<span class="badge rounded-pill text-bg-info p-1 px-2 font-size-10 fw-normal">Online Consultation</span>-->
                                    <!--<span class="badge rounded-pill text-bg-danger p-1 px-2 font-size-10 fw-normal">Emergency</span>--></td>
                                <td>
                                <a href="#!" class="patient-link"><img src="{{ $appointment->user->user_img_url ?? null }}" width="32" height="32" class="me-2" alt="" />{{$appointment->user->first_name ??''}} {{$appointment->user->last_name ??''}}</a>
                                </td>
                                <td>{{ $appointment->booking_time_slot }}</td>
                                <td>DR {{($appointment->doctor->user)?$appointment->doctor->user->name :'' }} <br>Specialist- {{($appointment->doctor->specialities ?? null) ? $appointment->doctor->specialities->pluck('name_en')->unique()->implode(', ') : null}}</td>
                                <td>
                                    @php
                                ...
                                <td>
                                    <div class="dropdown mt-4 mt-sm-0">
                                        ...
                                        <div class="dropdown-menu">
                                                <a class="dropdown-item" href="{{route('agent.appointmentdetail',['id'=>$appointment->id])}}">View Appointment</a>
    ...
    $(document).ready(function() {
        ...
        function loadMember(parentId){
            if (parentId) {
                $.ajax({
                    type: "GET",
                    url: "{{ url('agent/get-members') }}/" + parentId,
        ...
        function loadDepartments(parentId){
            if (parentId) {
                $.ajax({
                    type: "GET",
                    url: "{{ url('agent/get-hospital-departments') }}/" + parentId,
                    success: function (res) {
                        if (res) {
                            $('#department').empty();
        ...
        function loadDoctorsHospital(hospitalId, departmentId){
            if (hospitalId) {
                $.ajax({
                    type: "GET",
                    url: "{{ url('agent/get-hospital-doctors') }}/" + hospitalId,
                    success: function (res) {
                        if (res) {
                            $('#doctorSelct').empty();
        ...
        function loadDoctorsDepartment(departmentId){
            if(departmentId){
                $.ajax({
                    type: "GET",
                    url: "{{ url('agent/get-department-doctors') }}/" + departmentId,
                    success: function (res) {
                        if (res) {
                            $('#doctorSelct').empty();
                            $('#doctorSelct').append('<option value="">Select Doctor</option>');
...
<script>
    ...
    function checkAvailibility(doctor_id, date, selectedTime = null){
        ...
        if(date && doctor_id){
            $.ajax({
                type: "POST",
                url: "{{ url('agent/check_doctor_availability') }}",
                data:{
                    'booking_date': date,
    ...
    $("#cancelAppointment").click(function(e){
        ...
        $.ajax({
            url: "{{ url('agent/patient_appointment_cancel') }}",
            type: "POST",
            data : data,
            dataType:"JSON",
            processData : false,
...
$("#confirmAppointment").click(function(e){
     ...
     let dataconfirm = new FormData(form);
      ...
      $.ajax({
        url: "{{ route('agent.patient_appointment_confirm') }}",
        type: "POST",
        data : dataconfirm,
        dataType:"JSON",
        processData : false,
...
$("#buttoncompleted").click(function(e){
    ...
    let dataconfirm = new FormData(form);
     ...
     $.ajax({
       url: "{{ route('agent.patient_appointment_completed') }}",
       type: "POST",
       data : dataconfirm,
       dataType:"JSON",
       processData : false,
