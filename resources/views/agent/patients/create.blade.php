...
<div class="card mb-5">
    <div class="p-4 pt-5">
        <form id="admin_form" method="post" action="{{route('agent.patients.save')}}" class="registerform" autocomplete="off" data-parsley-validate="true">
            @csrf
...
<script>
    $(document).ready(function() {
        ...
        if (parentId) {
            $.ajax({
                type: "GET",
                url: "{{ url('agent/get-sub-insurance') }}/" + parentId,
