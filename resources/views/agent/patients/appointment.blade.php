...
<div class="card mb-5">
    ...
    <div class="card-header"><a href="{{route('agent.patients.create_appointment', $patient_id)}}" class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2 "><i class="mdi mdi-plus me-1"></i> Book an Appointment </a></div>
...
$(document).ready(function () {
    var table = $('#table_list').DataTable({
        ...
        ajax: {
            'type':'POST', 
            'url' : '{{ route("agent.patients.appointmentLoadData") }}',
            'data':{
                '_token': '{{csrf_token()}}',
