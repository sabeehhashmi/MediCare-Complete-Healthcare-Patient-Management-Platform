...
<div class="card mb-5">
    <!--<div class="card p-4">-->
    <form method="post" id="admin-form" action="{{ url('agent/hospitals/'.$hospital->id) }}" enctype="multipart/form-data"
            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-4">
                    ...
                    <div class="position-relative">
                        ...
                        <input type="text" class="form-control" id="phone1" name="direct_phone" placeholder="Enter Phone Number" />
                        <!-- <span class="bx bx-phone"></span> -->
                    </div>
                </div>
