...
<div class="card mb-5">
    <div class="p-4 pt-5">
        <form id="admin_form" method="post" action="{{route('agent.clinics.saveAppointment')}}" class="registerform" autocomplete="off">
            @csrf
            ...
            <div class="row">
                ...
                @if(($hospital->type ?? TYPE_HOSPITAL) == TYPE_HOSPITAL)
                <div class="col-xs-12 col-sm-6">
