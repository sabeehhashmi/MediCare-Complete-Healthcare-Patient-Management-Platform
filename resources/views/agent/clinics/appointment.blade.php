...
<div class="card mb-5">
    ...
    <div class="card-header"><a href="{{route('agent.clinics.create_appointment', $hospital_id)}}" class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2 "><i class="mdi mdi-plus me-1"></i> Book an Appointment </a></div>
...
$(document).ready(function () {
    var table = $('#table_list').DataTable({
        ...
        ajax: {
            'type':'POST', 
            'url' : '{{ route("agent.clinics.appointmentLoadData") }}',
            'data':{
                '_token': '{{csrf_token()}}',
    ...
    $(document).on('click', '.delete-appointment', function() {
        ...
        var href = '{{ url("agent/patients/delete-appointment") }}/' + id;
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    if (res['status'] == 0) {
                        ...
                        setTimeout(function() {
                            window.location.href = App.siteUrl('/agent/admin_users');
                        }, 1500);
                    }
     ...
     let data = new FormData(form);
      ...
      $.ajax({
        url: "{{ route('agent.doctors.patienttAppointmentSave') }}",
        type: "POST",
        data : data,
        dataType:"JSON",
        processData : false,
...
$("#cancelAppointment").click(function(e){
     ...
     let data = new FormData(form);
      ...
      $.ajax({
        url: "{{ route('agent.doctors.patienttAppointmentCancel') }}",
        type: "POST",
        data : data,
        dataType:"JSON",
        processData : false,
...
$("#confirmAppointment").click(function(e){
     ...
     let data = new FormData(form);
      ...
      $.ajax({
        url: "{{ route('agent.doctors.patienttAppointmentConfirmed') }}",
        type: "POST",
        data : data,
        dataType:"JSON",
        processData : false,
...
$("#confirmReschedule").click(function(e){
     ...
     let data = new FormData(form);
      ...
      $.ajax({
        url: "{{ route('agent.doctors.patienttAppointmentRescheduled') }}",
        type: "POST",
        data : data,
        dataType:"JSON",
        processData : false,
...
$("#completed").click(function(e){
     ...
     let data = new FormData(form);
      ...
      $.ajax({
        url: "{{ route('agent.doctors.patienttAppointmentCompleted') }}",
        type: "POST",
        data : data,
        dataType:"JSON",
        processData : false,
